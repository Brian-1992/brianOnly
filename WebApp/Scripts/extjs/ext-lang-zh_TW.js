...
Ext.define('Ext.locale.zh_TW.form.field.Base', {
    ...
    initComponent: function () {
        if (this.allowBlank !== undefined && !this.allowBlank) {
            ...
            this.fieldLabel = '<span style="vertical-align:middle;font-size:18px;font-weight:bold;color:red">*</span>' + this.fieldLabel;
        }
...
Ext.onReady(function () {
    ...
    Ext.define('MMIS.Message', {
        singleton: true,
        clientError: "W0021:輸入資料格式有誤",
        communicationError: "E0096:網路通訊錯誤"
    });
    ...
    Ext.define("Ext.locale.zh_TW.form.field.File", {
