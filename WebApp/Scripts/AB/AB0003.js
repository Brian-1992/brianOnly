...
Ext.onReady(function () {
    ...
    var T2Name = "";
    var arrP2 = ["1", "2"];
    var T6GetExcel = '../../../api/AB0003/Excel';
        ...
        buttons: [{
            ...
            handler: function () {
                if (this.up('form').getForm().isValid()) { // 檢查T1Form填寫資料是否符合規則(必填欄位都有填、輸入內容有符合正規表示式等)
                    ...
                    if ((this.up('form').getForm().findField('MAT_CLASS').getValue() == '08') && (this.up('form').getForm().findField('APPLY_KIND').getValue() == '1')) {
                        Ext.Msg.alert('提醒', '資訊耗材類只能臨時申請!');
                    }
                    else {
                ...
                T2FormMMCode,
                {
                    ...
                    handler: function () {
                        ...
                        if (!f.findField("MMCODE").readOnly) {
                            popMmcodeForm_AB0004(viewport, '/api/AB0003/GetMmcode', {
