...
Ext.onReady(function () {
    // var T1Get = '/api/AB0017/All'; // 查詢(改為於store定義)
    var T1Set = ''; // 新增/修改/刪除
    var T1Name = "通信申購入庫";
    ...
    var st_apply_kind = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AB0017/GetApplyKindCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var st_matclass = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AB0017/GetMatclassCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
            ...
            },
            {
                itemId: 'applyr', text: '取消入庫', disabled: true, handler: function () {
                    ...
                    if (selection.length === 0) {
                        ...
                        Ext.MessageBox.confirm('入庫', '是否確定取消入庫？單號如下<br>' + name, function (btn, text) {
                            if (btn === 'yes') {
                                Ext.Ajax.request({
                                    url: '/api/AB0017/ApplyR',
                                    method: reqVal_p,
                                    params: {
                                        DOCNO: docno
                                    },
    ...
    function setFormT1(x, t) {
        ...
        if (x === "I") {
            ...
            f.findField('DOCTYPE').setValue('CM2');
    ...
    var T2QueryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AB0017/GetMMCodeDocd', //指定查詢的Controller路徑
    ...
    var T2FormMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        width: 220,
        limit: 10, //限制一次最多顯示10筆
        queryUrl: '/api/AB0017/GetMMCodeCombo', //指定查詢的Controller路徑
                    ...
                    T2FormMMCode,
                    {
                        ...
                        handler: function () {
                            ...
                            if (!f.findField("MMCODE").readOnly) {
                                popMmcodeForm(viewport, '/api/AB0017/GetMmcode', {
    ...
    function showReport() {
        if (!win) {
            ...
            var qstring = '?fr=AB0017&p0=' + p0 + '&p1=' + p1 + '&p2=2';
