...
Ext.onReady(function () {
    // var T1Get = '/api/AB0005/All'; // 查詢(改為於store定義)
    var T1Set = ''; // 新增/修改/刪除
    var T1Name = "一般物品非庫備申請";
    ...
    var T2Name = "";
    var arrP2 = ["1", "2"];
    var T6GetExcel = '../../../api/AB0005/Excel';
    ...
    var st_pkdocno = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: '/api/AB0005/GetDocnopkCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            },
    ...
    var st_pknote = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: '/api/AB0005/GetDocpknoteCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            },
    ...
    var st_apply_kind = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AB0005/GetApplyKindCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var st_matclass = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AB0005/GetMatclassCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    function setFormT1(x, t) {
        ...
        if (x === "I") {
            ...
            f.findField('DOCTYPE').setValue('MR3');
        ...
        items: [{
            ...
            listeners: {
                "select": function (combobox, records, eOpts) {
                    var f = T1Form.getForm();
                    if (records.data.EXTRA1 == "2") {
                        f.findField('APPLY_KIND_N').setValue('臨時申請');
                        f.findField('APPLY_KIND').setValue('2');
                    }
                    else {
                        f.findField('APPLY_KIND_N').setValue('常態申請');
                        f.findField('APPLY_KIND').setValue('1');
    ...
    var T2QueryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AB0005/GetMMCodeDocd', //指定查詢的Controller路徑
    ...
    var T2FormMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        width: 220,
        limit: 10, //限制一次最多顯示10筆
        queryUrl: '/api/AB0005/GetMMCodeCombo', //指定查詢的Controller路徑
                    ...
                    T2FormMMCode,
                    {
                        ...
                        handler: function () {
                            ...
                            if (!f.findField("MMCODE").readOnly) {
                                popMmcodeForm_AB0004(viewport, '/api/AB0005/GetMmcode', {
    ...
    //if (st_getlogininfo.getAt(0).get('MR3') == "Y") {
    ...
    popWinForm = function () {
        var title = '';
        title = '一般物品非庫備 申請單號：' + T1LastRec.data.DOCNO;
