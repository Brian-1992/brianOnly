...
Ext.onReady(function () {
    // var T1Get = '/api/AB0004/All'; // 查詢(改為於store定義)
    var T1Set = ''; // 新增/修改/刪除
    var T1Name = "衛材庫備申請";
    ...
    var T2Name = "";
    var arrP2 = ["1", "2"];
    var T6GetExcel = '../../../api/AB0004/Excel';
    ...
    var st_pkdocno = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: '/api/AB0004/GetDocnopkCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            },
    ...
    var st_pknote = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: '/api/AB0004/GetDocpknoteCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            },
    ...
    var st_apply_kind = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AB0004/GetApplyKindCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var st_matclass = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AB0004/GetMatclassCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
        ...
        buttons: [
            {
                itemId: 'add', text: '新增', handler: function () {
                    T1Set = '/api/AB0004/CreateM'; // AB0004Controller的Create
                    msglabel('訊息區:');
                    setFormT1('I', '新增');
                }
            },
    ...
    function setFormT1(x, t) {
        ...
        if (x === "I") {
            ...
            f.findField('APPLY_KIND').setValue('1');  //常態申請
    ...
    var T2QueryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AB0004/GetMMCodeDocd', //指定查詢的Controller路徑
    ...
    var T2FormMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        width: 220,
        limit: 10, //限制一次最多顯示10筆
        queryUrl: '/api/AB0004/GetMMCodeCombo', //指定查詢的Controller路徑
                ...
                T2FormMMCode,
                {
                    ...
                    handler: function () {
                        ...
                        if (!f.findField("MMCODE").readOnly) {
                            popMmcodeForm_AB0004(viewport, '/api/AB0004/GetMmcode', {
    ...
    popWinForm = function () {
        var title = '';
        title = '衛材庫備 申請單號：' + T1LastRec.data.DOCNO;

        var strUrl = "AB0003_Form?docno=" + T1LastRec.data.DOCNO + "&mStoreid=1&matClass=" + T1LastRec.data.MAT_CLASS;
        if (!callableWin) {
