...
Ext.onReady(function () {
    //var T1Set = '';
    var T1Name = '庫存成本報表'
    var WHComboGet = '../../../api/AB0059/GetWHCombo';
    var MATComboGet = '../../../api/AB0059/GetMatCombo';
    var YMComboGet = '../../../api/AB0059/GetYMCombo';
    var GetWh_no = '../../../api/AB0059/getWH_NO';
    var reportUrl = '/Report/A/AB0059.aspx';
    var T1GetExcel = '../../../api/AB0059/Excel';
    ...
    var T1Store = Ext.create('WEBAPP.store.AB.AB0059VM', {
        listeners: {
