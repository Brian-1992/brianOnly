...
Ext.onReady(function () {
    ...
    function QueryTowhLoad() {

        Ext.Ajax.request({
            url: '/api/AB0023/GetTowh',
    ...
    function QueryFrwhLoad() {
        Ext.Ajax.request({
            url: '/api/AB0023/GetFrwh',
            method: reqVal_p,
            success: function (response) {
                var data = Ext.decode(response.responseText);
                if (data.success) {
                    ...
                    if (wh_nos.length > 0) {
                        queryFrwhStore.add({ WH_NO: '', WH_NAME: '' });
                        for (var i = 0; i < wh_nos.length; i++) {
                            queryFrwhStore.add({ WH_NO: wh_nos[i].WH_NO, WH_NAME: wh_nos[i].WH_NAME });
                        }
                    }
                }
            },
    ...
    var T1Query = Ext.widget({
        ...
        items: [
            ...
            },
            {
                ...
                //allowBlank: false,
                items: [
                    { boxLabel: '申請中', name: 'rb', inputValue: '1201' },
                    { boxLabel: '點收中', name: 'rb', inputValue: '1202', checked: true },
                    ...
                    if (selection.length) {
                        ...
                        Ext.MessageBox.confirm('訊息', '確認是否結案單據號碼<br>' + name, function (btn, text) {
                            if (btn === 'yes') {
                                ...
                                Ext.Ajax.request({
                                    url: '/api/AB0023/UpdateStatusBySp',
                                    method: reqVal_p,
                                    params: {
                                        DOCNO: docno
                                    },
    ...
    var T1Grid = Ext.create('Ext.grid.Panel', {
        ...
        listeners: {
            ...
            itemclick: function (self, record, item, index, e, eOpts) {
                ...
                if (T1LastRec.data.FLOWID.split(' ')[0] == "1202") {                    
        ...
        items: [
            {
                ...
                items: [
                    ...
                    {
                        boxLabel: '已退回', name: 'rb', inputValue: 'B',
                        handler: function () {
                            setFormVisible(true, false);
                    ...
                    {
                        boxLabel: '處理中', name: 'rb', inputValue: 'C', checked: true,
                        handler: function () {
                            setFormVisible(true, false);
    ...
    var T2Tool = Ext.create('Ext.PagingToolbar', {
        ...
        buttons: [
            ...
            //},
            {
                itemId: 't2edit', text: '修改',hidden:true, disabled: true, handler: function () {
                    T2Set = '/api/AB0023/UpdateD';
                    setFormT2("U", '修改');
                }
            },
            {
    ...
    var T2Grid = Ext.create('Ext.grid.Panel', {
        ...
        listeners: {
            ...
            itemclick: function (self, record, item, index, e, eOpts) {
                ...
                if (T2LastRec != null) {
                    if (T1LastRec.data.FLOWID.split(' ')[0] == "1202" && T2LastRec.data.STAT.split(' ')[0] == "C") {
