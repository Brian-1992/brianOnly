...
Ext.onReady(function () {
    // var T1Get = '/api/AB0008/All'; // 查詢(改為於store定義)
    var T1Set = ''; // 新增/修改/刪除
    var T1Name = "通信申請核撥";
    var T3GetExcel = '/api/AB0008/Excel3';
    var T4GetExcel = '/api/AB0008/Excel4';
    ...
    var st_matclass = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AB0008/GetMatclassCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    function setFormT1(x, t) {
        ...
        if (x === "I") {
            ...
            f.findField('DOCTYPE').setValue('CM1');
    ...
    var T2QueryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AB0008/GetMMCodeDocd', //指定查詢的Controller路徑
    ...
    var T2FormMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        width: 220,
        limit: 10, //限制一次最多顯示10筆
        queryUrl: '/api/AB0008/GetMMCodeCombo', //指定查詢的Controller路徑
                ...
                T2FormMMCode,
                {
                    ...
                    handler: function () {
                        ...
                        if (!f.findField("MMCODE").readOnly) {
                            popMmcodeFormEC(viewport, '/api/AB0008/GetMmcode', {
