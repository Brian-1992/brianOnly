...
Ext.onReady(function () {
    // var T1Get = '/api/AA0057/All'; // 查詢(改為於store定義)
    var T1Set = ''; // 新增/修改/刪除
    //var T1Name = "收費基本檔清單查詢";
    var T1Name = "收費基本檔異動歷史資料維護作業";

    var T1Rec = 0;
    var T1LastRec = null;
    var T1GetExcel = '../../../api/AA0057/Excel';

    var GetOrderDCFlag = '../../../api/AA0057/GetOrderDCFlag';
    var GetCaseFrom = '../../../api/AA0057/GetCaseFrom';
    var GetInsuSignI = '../../../api/AA0057/GetInsuSignI';
    var GetInsuSignO = '../../../api/AA0057/GetInsuSignO';
    ...
    var T1Store = Ext.create('WEBAPP.store.AA.AA0057VM', { // 定義於/Scripts/app/store/AA/AA0057VM.js
        listeners: {
        ...
        buttons: [
            {
                ...
                handler: function () {
                    ...
                    var p = new Array();
                    p.push({ name: 'FN', value: today + '_收費基本檔異動歷史.xls' });
