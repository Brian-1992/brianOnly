...
Ext.onReady(function () {
    // var T1Get = '/api/AA0150/All'; // 查詢(改為於store定義)
    var T1Set = ''; // 新增/修改/刪除
    var T1Name = "換貨作業";
    ...
    var st_STKTRANSKIND = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0150/GetSTKTRANSKINDCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
        ...
        proxy: {
            ...
            beforeload: function (store, options) {
                ...
                var np = {
                    ...
                    p1: T2Form.getForm().findField('DOCNO').getValue()
                };
    ...
    var st_MatclassQ = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0150/GetMatclassQCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var st_Matclass = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0150/GetMatclassCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
        ...
        , listeners: {
            beforeload: function (store, options) {
                ...
                var np = {
                    ...
                    p4: T1QueryForm.getForm().findField('P4').getValue(), //換貨類別
    ...
    function setFormT1(x, t) {
        ...
        if (x === "I") {
            ...
            f.findField('FLOWID_N').setValue('換貨中');
            ...
            f.findField('STKTRANSKIND').setValue('1');
                ...
                selectionchange: function (selectionModel, selected, options) {
                    if (selected.length > 0) {
                        ...
                        for (var i = 0; i < selected.length; i++) {
                            if (selected[i].data.FLOWID.substr(selected[i].data.FLOWID.length - 1, 1) != '1') {
    ...
    var GetLOT_NO = '../../../api/AA0150/GetLOT_NO';
    var GetEXP_DATE = '../../../api/AA0150/GetEXP_DATE';
    var GetINV_QTY = '../../../api/AA0150/GetINV_QTY';
    var GetM_DISCPERC = '../../../api/AA0150/GetM_DISCPERC';
    var GetM_CONTPRICE = '../../../api/AA0150/GetM_CONTPRICE';
    ...
    var T2QueryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AA0150/GetMMCodeDocd', //指定查詢的Controller路徑
    ...
    var T2FormMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        //width: 220,
        limit: 10, //限制一次最多顯示10筆
        queryUrl: '/api/AA0150/GetMMCodeCombo', //指定查詢的Controller路徑
        ...
        listeners: {
            change: function (combo, newValue, oldValue, eOpts) {
                ...
                if (newValue != '') {
                    Ext.Ajax.request({
                        url: '/api/AA0150/GetSelectMmcodeDetail',
                        method: reqVal_g,
                        params: {
                            MMCODE: newValue,
                        ...
                        success: function (response) {
                            ...
                            if (data.success) {
                                ...
                                if (tb_data.length > 0) {
                                    ...
                                    if (f.findField('INOUT').getValue() == '2') {
                                        SetLOT_NO(tb_data[0].MMCODE, true);
                                    }
                                    var apvqty = 0;
                                    var totprice = 0;
                                    var contprice = Number(tb_data[0].M_CONTPRICE);
                ...
                T2FormMMCode,
                {
                    ...
                    handler: function () {
                        ...
                        if (!f.findField("MMCODE").readOnly) {
                            popMmcodeForm_14(viewport, '/api/AA0150/GetMmcode', {
                ...
                }/*,
                {
                    ...
                    handler: function () {
                        ...
                        if (!f.findField("LOT_NO").readOnly) {
                            popLotnoForm(viewport, '/api/AA0150/GetLotno', {
                                MMCODE: f.findField("MMCODE").getValue(),
                ...
                if ((T2Form.getForm().findField("MMCODE").getValue()) == "" ||
                    ...
                    if ((this.up('form').getForm().findField('LOT_NO').getValue() == '' || this.up('form').getForm().findField('LOT_NO').getValue() == null)
                        ...
                        if (this.up('form').getForm().findField('APVQTY').getValue() == '0'){
                            ...
                            var sum_ex = Number(T2Query.getForm().findField('SUM_EX').getValue());
                            var sum_in = Number(T2Query.getForm().findField('SUM_IN').getValue());
                            if (this.up('form').getForm().findField('INOUT').getValue() == '2' && pAPVQTY > pINVQTY) {
        ...
        buttons: [
            {
                itemId: 'add', text: '新增', disabled: true, handler: function () {
                    T11Set = '../../../api/AA0150/CreateD';
                    setFormT2('I', '新增');
                }
            },
            {
                itemId: 'edit', text: '修改', disabled: true, handler: function () {
                    T11Set = '../../../api/AA0150/UpdateD';
                    setFormT2("U", '修改');
                }
            },
            {
