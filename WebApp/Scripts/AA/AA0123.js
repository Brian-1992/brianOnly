...
Ext.onReady(function () {
    ...
    var UrlReport = '/Report/A/AA0123.aspx';
    ...
    var T1Query = Ext.widget({
        ...
        },
        {
            ...
            handler: function () {
                ...
                var p2 = T1Query.getForm().findField('P2').checked ? 'Y' : 'N';
                if (p0 == "" || p1 == "") {
