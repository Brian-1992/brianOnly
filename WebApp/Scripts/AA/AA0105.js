...
Ext.onReady(function () {
    ...
    var T1GetExcel = '../../../api/AA0105/Excel';

    Ext.override(Ext.grid.column.Column, { menuDisabled: true });
    var WH_NOComboGet = '../../../api/AA0105/GetWH_NOComboOne';  //庫別級別(1庫 2局(衛星庫) 3病房 4科室 5戰備庫)
    ...
    var st_MatClass = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0105/GetMatClassCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var T1QuryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AA0105/GetMMCODECombo', //指定查詢的Controller路徑
