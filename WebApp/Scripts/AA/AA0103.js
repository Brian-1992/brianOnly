...
Ext.onReady(function () {
    ...
    var T1GetExcel = '../../../api/AA0102/Excel_AA0103';
    ...
    var T1Store = Ext.create('WEBAPP.store.AA.AA0103', {
        listeners: {
        ...
        buttons: [
            {
                ...
                handler: function () {
                    ...
                    if ((T1Query.getForm().findField('D0').getValue() != "") && T1Query.getForm().findField('SHOWDATA').getChecked()[0].inputValue != "") {
                        p.push({ name: 'FN', value: '盤點未完全單位查詢報表' });
    ...
    function showReport() {
        if (!win) {
            var winform = Ext.create('Ext.form.Panel', {
                ...
                layout: 'fit',
                closable: false,
                html: '<iframe src="' + reportUrl + '?type=' + "AA0103"
    ...
    //for (var i = 0; i < 5; i++) { //計算目前到前五個月
    //    st_month.add({ VALUE: getInterval(i), COMBITEM: getInterval(i) });
    //}
