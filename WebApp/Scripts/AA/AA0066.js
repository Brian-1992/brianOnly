...
Ext.onReady(function () {
    ...
    var St_MatclassGet = '../../../api/AA0066/GetMatclassCombo';
    ...
    var T1QuryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AA0066/GetMMCODECombo', //指定查詢的Controller路徑
    ...
    var T1Store = Ext.create('WEBAPP.store.BackStorageDt', { // 定義於/Scripts/app/store/MiUnitcode.js
        listeners: {
            ...
            },
            {
                text: '列印', handler: function () {
                    if (T1Store.getCount() > 0) {
                        reportUrl = '/Report/A/AA0066.aspx';
                        showReport();
                    }
                    else
    ...
    function showReport() {
        if (!win) {
            var winform = Ext.create('Ext.form.Panel', {
                ...
                layout: 'fit',
                closable: false,
                html: '<iframe src="' + reportUrl + '?type=' + "AA0066"
