...
Ext.onReady(function () {
    var T1Name = "供應中心基準量維護";
    var T1Set = '/api/AA0179/Update';
    var T1Rec = 0;
    var T1LastRec = null;
    var p0_default = "";
    var ro_type = "";
    ...
    var SetMatClassComboGet = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0179/GetMatClassSubCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var T1QueryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AA0179/GetMMCodeCombo', //指定查詢的Controller路徑
    ...
    var uriWH_NoCombo = '/api/AA0179/GetWH_NoCombo';
    ...
    var T1Store = Ext.create('WEBAPP.store.AA.AA0179', {
        listeners: {
                ...
                handler: function () {
                    ...
                    Ext.MessageBox.confirm('匯出', '是否確定匯出？', function (btn, text) {
                        if (btn === 'yes') {
                            ...
                            PostForm('/api/AA0179/GetExcel', p);
                            msglabel('訊息區:匯出完成');
                        }
                    });
                }
    ...
    function setFormDefaultDisplay() {
        ...
        T1Form.getForm().findField("SAFE_QTY").labelEl.update('供應中心最低安全庫存量(X' + T1LastRec.data.SAFE_PERC + 'RO)');
        T1Form.getForm().findField("NORMAL_QTY").labelEl.update('供應中心正常庫存量(X' + T1LastRec.data.NORMAL_PERC + 'RO)');
        ...
        items: [
            {
                ...
                text: '範本', handler: function () {
                    var p = new Array();
                    PostForm('/api/AA0179/GetExcelExample', p);
                    msglabel('訊息區:匯出完成');
                }
            },
            {
