...
Ext.onReady(function () {
    // var T1Get = '/api/AA0131/All'; // 查詢(改為於store定義) COPY FROM AB0093
    var T1Set = ''; // 新增/修改/刪除
    var T1Name = "氣體申請";
    var T1Rec = 0;
    var T1LastRec = null;
    ...
    var st_apply_kind = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0131/GetApplyKindCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var st_matclass = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0131/GetMatclassCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var st_appdeptcombo = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0131/GetAppDeptCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
        ...
        buttons: [
            {
                itemId: 'add', text: '新增', handler: function () {
                    T1Set = '/api/AA0131/CreateM'; // AA0131Controller的Create
                    msglabel('訊息區:');
                    setFormT1('I', '新增');
                }
            },
    ...
    var T2QueryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AA0131/GetMMCodeDocd', //指定查詢的Controller路徑
    ...
    var T2FormMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        width: 220,
        limit: 10, //限制一次最多顯示10筆
        queryUrl: '/api/AA0131/GetMMCodeCombo', //指定查詢的Controller路徑
                ...
                T2FormMMCode,
                {
                    ...
                    handler: function () {
                        ...
                        if (!f.findField("MMCODE").readOnly) {
                            popMmcodeForm(viewport, '/api/AA0131/GetMmcode', {
