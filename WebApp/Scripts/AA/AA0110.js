...
Ext.onReady(function () {
    ...
    var st_matclass = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0110/GetMatclassCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var st_doctype = Ext.create('Ext.data.Store', {
        proxy: {
            ...
            url: '/api/AA0110/GetDoctypeCombo',
            reader: {
                type: 'json',
                rootProperty: 'etts'
            }
    ...
    var T2QueryMMCode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        queryUrl: '/api/AA0110/GetMMCodeDocd', //指定查詢的Controller路徑
        ...
        buttons: [
            {
                itemId: 'add', text: '新增', disabled: true, handler: function () {
                    T11Set = '../../../api/AA0110/CreateD';
                    setFormT2('I', '新增');
                }
            },
            {
                itemId: 'edit', text: '修改', disabled: true, handler: function () {
                    T11Set = '../../../api/AA0110/UpdateD';
                    setFormT2("U", '修改');
                }
            },
            {
