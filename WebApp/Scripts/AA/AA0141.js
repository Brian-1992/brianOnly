        ...
        buttons: [
            {
                itemId: 'load', text: '載入品項',  handler: function () {
                    Ext.Ajax.request({
                        url: '/api/AA0141/LoadDetailItems',
                        method: reqVal_p,
                        params: {
                            docno: T1LastRec.data.DOCNO
                        },
