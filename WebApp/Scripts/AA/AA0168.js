...
Ext.onReady(function () {
    ...
    var T1Get = '/api/AA0168/GetQueryData';
    var getMatClass = '../../../api/AA0168/GetMatclassCombo';
    var getWh = '../../../api/AA0168/GetWH';
    var getExcel = '../../../api/AA0168/Excel';
    var reportUrl = '/Report/A/AA0168.aspx';
    var T1RecLength = 0;
    var T1LastRec = null;
    var vMatClass = "";
    var vPrintTitle = "";
        ...
        buttons: [
            {
                ...
                handler: function () {
                    ...
                    if (T1Store.getCount() > 0) {
                        ...
                        param.push({ name: 'frompgm', value: 'AA0168' });
