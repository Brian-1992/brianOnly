...
var WH_NOComboGet = '../../../api/AA0108/GetWH_NOComboOne';  //庫別級別(1庫 2局(衛星庫) 3病房 4科室 5戰備庫)
...
var reportUrl = '/Report/A/AA0108.aspx';
var P0 = '';
var P1 = '';
var P2 = '';
var P3 = '';
    ...
    var T1Query = Ext.widget({
        ...
        },
        {
            ...
            items: [
                ...
                //    hidden: true,
                //    items: [
                //        { boxLabel: '口服', name: 'rb2', width: 70, inputValue: '1' },
                //        { boxLabel: '非口服', name: 'rb2', width: 70, inputValue: '2' },
                //        { boxLabel: '1~3級管制', name: 'rb2', width: 80, inputValue: '3' },
                //        { boxLabel: '4級管制', name: 'rb2', width: 70, inputValue: '4' },
                //        { boxLabel: '麻醉科公藥', name: 'rb2', width: 70, inputValue: '5' },
                //        { boxLabel: '麻醉科專科藥', name: 'rb2', width: 70, inputValue: '6' },
                //        { boxLabel: '一般藥品', name: 'rb2', width: 70, inputValue: '7' },
                //        { boxLabel: '大瓶點滴', name: 'rb2', width: 70, inputValue: '8' },
                //        { boxLabel: '不區分', name: 'rb2', width: 70, inputValue: '99' },
                //        { boxLabel: '消耗為負(全院)', name: 'rb2', width: 110, inputValue: '-1' }
                //    ]
                //},
                //{
                ...
                //        { boxLabel: '庫備品', name: 'rb1', itemid: 'r1', width: 70, inputValue: '1', checked: true },
                //        { boxLabel: '非庫備品', name: 'rb1', width: 70, inputValue: '0' },
                //        { boxLabel: '小採', name: 'rb1', width: 70, inputValue: '3' },
                //        { boxLabel: '不區分', name: 'rb1', width: 70, inputValue: '99' },
                //        { boxLabel: '消耗為負(全院)', name: 'rb1', width: 120, inputValue: '-1' }
                //    ]
                //},
                {
                    xtype: 'button',
