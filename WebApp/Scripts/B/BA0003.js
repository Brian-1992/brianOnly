...
Ext.onReady(function () {
    ...
    var MATComboGet = '../../../api/BA0003/GetMATCombo';
    var MmcodeComboGet = '../../../api/BA0003/GetMmcodeCombo';
    var Wh_noComboGet = '../../../api/BA0003/GetWh_noCombo';
    var GetTot = '../../../api/BA0003/GetTot';
    var reportUrl = '/Report/B/BA0003.aspx';
    ...
    var T1FormMmcode = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        listeners: {
            change: function (combo, newValue, oldValue, eOpts) {
                ...
                if (act_code != '') {
                    Ext.Ajax.request({
                        url: '/api/BA0003/GetSelectMmcodeDetail',
                        method: reqVal_g,
                        params: {
                            MMCODE: newValue,
    ...
    var T2Store = Ext.create('Ext.data.Store', { // 定義於/Scripts/app/store/PhVender.js
        model: 'T2Model',
        pageSize: 20, // 每頁顯示筆數
        remoteSort: true,
