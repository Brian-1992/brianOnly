...
Ext.onReady(function () {
    ...
    var T1Tool = Ext.create('Ext.PagingToolbar', {
        ...
        buttons: [
            ...
            ////},
            {
                ...
                itemId: 'hLink', text: 'UDI寄售庫存查詢', handler: function () {
                    window.open("https://tsghudi.ndmctsgh.edu.tw/aHopWeb/Home/Inv");
                }
            }]
    });
        ...
        buttons: [{
            ...
            handler: function () {
                if ((T1Form.getForm().findField("AGEN_NO").getValue()) == "") {
                    ...
                    Ext.Msg.alert('提醒', "<span style='color:red'>現有寄放量需大於等於0</span>，請重新輸入。");
                    msglabel(" <span style='color:red'>現有寄放量需大於等於0</span>，請重新輸入。");
                }
    ...
    function setFormT1(x, t) {
        ...
        if (x === "I") {
            ...
            setCmpShowCondition(true, false, false, true, false, false, true, false, true, false, true, false);
            Ext.getCmp("mmcodeComboSet_i").getComponent('btnMmcode_i').show();
        }
        else {

            u = f.findField('DEPT');
            setCmpShowCondition(false, true, false, false, true, false, true, false, false, true, true, false);
        ...
        if (f.isValid()) {
            ...
            f.submit({
                ...
                success: function (form, action) {
                    myMask.hide();
                    setCmpShowCondition(false, false, true, false, false, true, false, true, false, true, false, true);
                    Ext.getCmp("mmcodeComboSet_i").getComponent('btnMmcode_i').hide();
                    T1Load();
    ...
    function setFormT2(x, t) {
        ...
        if (x === "I") {
            ...
            msglabel("<span style='color:red'>注意! 已存在資料不能更改[異動數量],請新增加一筆資料由系統加減[現有寄放量]</span>");
    ...
    function T2Submit() {
        ...
        if (f.isValid()) {
            ...
            f.submit({
                ...
                success: function (form, action) {
                    myMask.hide();
                    setCmpShowCondition_D(false, true, false, false, true, true, false, false, true);
                    var f2 = T2Form.getForm();
                    var r = f2.getRecord();
                    switch (f2.findField("x").getValue()) {
                        case "I":
    ...
    //控制不可更改項目的顯示
    function setCmpShowCondition(AGEN_NO, AGEN_NAMEC_DISPLAY, AGEN_NAMEC_TEXT, MMCODE, MMCODE_DISPLAY, MMCODE_TEXT, DEPT, DEPT_NAME_TEXT, QTY, QTY_DISPLAY, STATUS, STATUS_TEXT) {
        var f = T1Form.getForm();
        AGEN_NO ? showComponent(f, "AGEN_NO") : hideComponent(f, "AGEN_NO");
        AGEN_NAMEC_DISPLAY ? showComponent(f, "AGEN_NAMEC_DISPLAY") : hideComponent(f, "AGEN_NAMEC_DISPLAY");
        AGEN_NAMEC_TEXT ? showComponent(f, "AGEN_NAMEC_TEXT") : hideComponent(f, "AGEN_NAMEC_TEXT");
    ...
    setCmpShowCondition(false, false, true, false, false, true, false, true, true, false, false, true);
    setCmpShowCondition_D(false, true, false, false, true, true, false, false, true);
    Ext.getCmp("mmcodeComboSet_i").getComponent('btnMmcode_i').hide();
