...
Ext.onReady(function () {
    ...
    var T1Store = Ext.create('WEBAPP.store.PhSmallMail', { // 定義於/Scripts/app/store/PhSmallMail.js
        listeners: {
    ...
    var T1Tool = Ext.create('Ext.PagingToolbar', {
        ...
        buttons: [
            ...
            //        T1Set = '/api/BC0010/Create'; // BE0002Controller的Create
            //        setFormT1('I', '新增');
            //    }
            //},
            {
                itemId: 'edit', text: '修改', disabled: true, handler: function () {
                    T1Set = '/api/BC0010/Update';
                    setFormT1("U", '修改');
                }
            }
            //, {
    ...
    function setFormT1(x, t) {
        ...
        if (x === "I") {
            isNew = true;
            var r = Ext.create('WEBAPP.model.PhSmallMail'); // /Scripts/app/model/PhSmallMail.js
            T1Form.loadRecord(r); // 建立空白model,在新增時載入T1Form以清空欄位內容
            u = f.findField("SEND_TO"); 
            u.setReadOnly(false);
            u.clearInvalid();
        }
        else {
        ...
        f.findField('MAIL_ADD').setReadOnly(false);
                ...
                success: function (form, action) {
                    ...
                    switch (f2.findField("x").getValue()) {
                        case "I":
                            ...
                            //T1Query.getForm().findField('P0').setValue(v.SEND_TO);
                            msglabel('訊息區:資料新增成功');
                            break;
                        case "U":
                            var v = action.result.etts[0];
