Ext.define('WEBAPP.store.CE0021VM', {
    ...
    stores: {
        ...
        DetailExclude: {
            ...
            proxy: {
                ...
                url: '/api/CE0021/GetDetailExclude',
                reader: {
                    type: 'json',
                    rootProperty: 'etts',
                    totalProperty: 'rc'
        ...
        DetailInclude: {
            ...
            proxy: {
                ...
                url: '/api/CE0021/GetDetailInclude',
                reader: {
                    type: 'json',
                    rootProperty: 'etts',
                    totalProperty: 'rc'
        ...
        MasterInsertList: {
            ...
            proxy: {
                ...
                url: '/api/CE0021/GetMasterInsertList',
                reader: {
                    type: 'json',
                    rootProperty: 'etts',
                    totalProperty: 'rc'
