...
//定義FileGridField元件
Ext.define('WEBAPP.form.ImageGridField', {
                    ...
                    renderer: function (val, meta, record) {
                        ...
                        if (record.get('DN')) {
                            switch (record.get('FT')) {
                                ...
                                case 'JPEG':
                                case 'PNG':
                                    result = '<a href="javascript:FileUtil.ViewImage({fileGuid:\'' + record.get('FG') + '\'});"><img src="../../../Images/TRA/TRASearch.gif"></a> ';
                                    result += '<a href="javascript:FileUtil.DownloadFile({fileGuid:\'' + record.get('FG') + '\'});"> <img src="/api/File/DownloadImage/' + record.get("FG") + '" alt="' + record.get('FN') + '" style="width:150px"></a>';
                                    break;
                                default:
