...
Ext.onReady(function () {
    ...
    var T1Grid = Ext.create('Ext.grid.Panel', {
        ...
        listeners: {
            ...
            selectionchange: function (model, records, a, b, c) {
    ...
    T1Grid.on('cellclick',
          function () {
              ...
              var e = arguments[6];
              var eOpts = arguments[7];
              if (cellIndex == 0) {
                  T1Grid.setVisible(false);
                  T2Grid.setVisible(true);
              }
          },
          this
       );
    ...
    var T2Tool = Ext.create('Ext.PagingToolbar', {
        ...
        buttons: [
            {
                itemId: 'back', text: '回上頁', handler: function () {
                    T1Grid.setVisible(true);
                    T2Grid.setVisible(false);
                }
            },
            {
                itemId: 'add', text: '新增', disabled: true, handler: function () {
                    T11Set = '../../../api/SP1020/CreateD';
                    setFormT2('I', '新增');
                }
            },
            {
                itemId: 'edit', text: '修編', disabled: true, handler: function () {
                    T11Set = '../../../api/SP1020/UpdateD';
                    setFormT2("U", '修編');
                }
            },
            {
