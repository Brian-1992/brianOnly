...
Ext.onReady(function () {
    ...
    function T11Cleanup() {
        ...
        T11Form.down('#cancel').hide();
        T11Form.down('#submit').hide();
        viewport.down('#form').setTitle('瀏覽');
        setFormT11a();
    }
    ...
    function T111Cleanup() {
        ...
        T111Form.down('#cancel').hide();
        T111Form.down('#submit').hide();
        viewport.down('#form').setTitle('瀏覽');
        setFormT111a();
    }
    ...
    function setFormT111(x, t) {
        viewport.down('#t1Grid').mask();
        viewport.down('#form').setTitle(t + T111Name);
        viewport.down('#rightTab').expand();
        RightTabs.setActiveTab(RightTabs.down('#form'));
        var f2 = T111Form.getForm();
        if (x === "I") {
