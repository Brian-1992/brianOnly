...
Ext.onReady(function () {
    ...
    var T1Form = Ext.widget({
        ...
        buttons: [{
            ...
            itemId: 'cancel', text: '取消', handler: T1Cleanup
        }]
    });
    function T1Submit() {
        ...
        buttons: [
            {
                text: '查詢', handler: function () {
                    ...
                    if (T1Query.hidden === true) { T1Query.setVisible(true); T2Query.setVisible(false); }
                }
            },
            {
    ...
    var T2Form = Ext.widget({
        ...
        buttons: [{
            ...
            handler: function () {
                ...
                var confirmSubmit = win2.title.substring(0, 2);
                Ext.MessageBox.confirm(confirmSubmit, '是否確定' + confirmSubmit + '?', function (btn, text) {
                    if (btn === 'yes') {
                        T2Submit();
                    }
        ...
        buttons: [
            {
                text: '查詢', handler: function () {
                    viewport.down('#filter').expand();
                    if (T2Query.hidden === true) { T1Query.setVisible(false); T2Query.setVisible(true); }
                }
            },
            {
    ...
    if (!win2) {
        win2 = Ext.widget('window', {
            ...
            modal: true,
            items: T2Form,
            defaultFocus: T2Form.getForm().findField('D1')
        });
    }
    function showWin2() {
