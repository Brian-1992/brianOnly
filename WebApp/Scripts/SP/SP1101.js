...
Ext.onReady(function () {
    ...
    function T11Load() {
        ...
        T11Store.getProxy().setExtraParam("p0", T11Result);
        ...
        columns: {
            ...
            items: [{
                ...
                renderer: function (val, meta, record) {
                    return '<a href=\'javascript:popP11ItemDetail();\'><img src="../../../Images/TRA/TRASearch.gif" width="20vh" height="20vh" align="absmiddle" /></a>';
                }
            }, {
                text: "用藥類別",
    ...
    var T12Grid = Ext.create('Ext.grid.Panel', {
        ...
        columns: {
            ...
            items: [{
                ...
                renderer: function (val, meta, record) {
                    return '<a href=\'javascript:popP12ItemDetail();\'><img src="../../../Images/TRA/TRASearch.gif" width="20vh" height="20vh" align="absmiddle" /></a>';
                }
            }, {
                text: "原製造商",
    ...
    var T21Grid = Ext.create('Ext.grid.Panel', {
        ...
        columns: {
            ...
            items: [{
                ...
                renderer: function (val, meta, record) {
                    return '<a href=\'javascript:popP21ItemDetail();\'><img src="../../../Images/TRA/TRASearch.gif" width="20vh" height="20vh" align="absmiddle" /></a>';
                }
            }, {
                text: "用藥類別",
                dataIndex: 'E_DRUGCLASS_D',
    ...
    var T22Grid = Ext.create('Ext.grid.Panel', {
        ...
        columns: {
            ...
            items: [{
                ...
                renderer: function (val, meta, record) {
                    return '<a href=\'javascript:popP22ItemDetail();\'><img src="../../../Images/TRA/TRASearch.gif" width="20vh" height="20vh" align="absmiddle" /></a>';
                }
            }, {
                text: "庫房分類",
                dataIndex: 'WH_KIND_D',
    ...
    popP11ItemDetail = function () {
        if (!callableWin) {
            ...
            callableWin = GetPopWin(viewport, popform, '院內碼明細', viewport.width * 0.9, viewport.height * 0.8);
        }
        callableWin.show();
        popform.loadRecord(T11LastRec);
    }

    popP12ItemDetail = function () {
        if (!callableWin) {
            var popform = Ext.create('Ext.form.Panel', {
                id: 'itemDetail',
                height: '100%',
        ...
        callableWin.show();
        popform.loadRecord(T12LastRec);
    }

    popP21ItemDetail = function () {
        if (!callableWin) {
            var popform = Ext.create('Ext.form.Panel', {
                id: 'itemDetail',
                height: '100%',
            ...
            callableWin = GetPopWin(viewport, popform, '庫房代碼明細', viewport.width * 0.9, viewport.height * 0.8);
        }
        callableWin.show();
        popform.loadRecord(T21LastRec);
    }

    popP22ItemDetail = function () {
        if (!callableWin) {
            var popform = Ext.create('Ext.form.Panel', {
                id: 'itemDetail',
                height: '100%',
