...
Ext.onReady(function () {
    var T1Get = '/api/UR1017/GetByUser';
    var T1Create = '/api/UR1017/Create';
    var T1Copy = '/api/UR1017/Copy';
    var T1Update = '/api/UR1017/Update';
    var T1Delete = '/api/UR1017/Delete';
    var T1Set = '/api/UR1017/Change';
    var T1Name = '';
        ...
        buttons: [{
            ...
            handler: function () {
                if (this.up('form').getForm().isValid()) {
                    ...
                    Ext.Msg.alert('警告', '輸入資料格式有誤');//option
                    msglabel('輸入資料格式有誤');
                }
            }
        }, {
