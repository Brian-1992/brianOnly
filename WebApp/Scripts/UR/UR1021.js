...
Ext.onReady(function () {
    //Master
    var T1Get = '/api/UR1021/QueryM';
    var T1GetExcel = '../../../api/UR1021/ExcelM';
    var T1Name = "";


    //Detail
    var T11Get = '/api/UR1021/QueryD';
    var T11GetExcel = '../../../api/UR1021/ExcelD';
    var T11Name = "參數明細";
    ...
    Ext.define('T1Model', {
        ...
        fields: [
            ...
            { name: 'ED', type: 'date' },//發生日期
            { name: 'MSGV', type: 'string' },//展示訊息
            { name: 'MSG', type: 'string' },//簡易訊息
            { name: 'ST', type: 'string' } //詳細訊息
        ]
    });
    ...
    var T1Tool = Ext.create('Ext.PagingToolbar', {
        ...
        buttons: [{
            ...
            handler: function () {
                var p = new Array();
                p.push({ name: 'FN', value: '系統錯誤查詢.xls' });
    ...
    var T2Tool = Ext.create('Ext.PagingToolbar', {
        ...
        //    handler: function () {
        //        var p = new Array();
        //        p.push({ name: 'FN', value: '系統錯誤查詢參數明細.xls' });
        //        p.push({ name: 'p0', value: T1F1 });
        //        PostForm(T11GetExcel, p);
        //        msglabel('訊息區:匯出完成');
        //    }
        //}]
    });
