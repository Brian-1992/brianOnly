...
Ext.onReady(function () {
    ...
    var T5Get = '/api/UR1004/GetRolesInUser';
    var T6Get = '/api/UR1004/GetRolesNotInUser';
        ...
        listeners: {
            selectionchange: function (model, records) {
                ...
                if (records[0]) {
                    ...
                    T2Form.getForm().findField('RLNA').setValue(records[0].get('RLNA'));
    ...
    var T2Grid = Ext.create('Ext.grid.Panel', {
        ...
        listeners: {
            selectionchange: function (model, records) {
                ...
                T3Grid.down('#add').setDisabled(true);
                if (records[0]) {
    ...
    var T5Grid = Ext.create('Ext.grid.Panel', {
        ...
        listeners: {
            selectionchange: function (model, records) {
                ...
                T6Grid.down('#add').setDisabled(true);
                if (records[0]) {
        ...
        listeners: {
            selectionchange: function (model, records) {
                ...
                if (records[0]) {
                    ...
                    f.findField('RLNA').setValue(records[0].get('RLNA'));
                }
            }
        }
    });
