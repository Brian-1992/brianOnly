...
Ext.onReady(function () {
    ...
    //var T1GetExcel = '../../../api/AA0066/Excel';
    ...
    var T1Query = Ext.widget({
        ...
        items: [
            ...
            items: [
                ...
                //    text: '手機板',
                //    handler: function () {
                //        //location.href = "../../../Form/Index/CE0009";
                //        parent.link2('/Form/Index/CE0009', '三盤數量輸入作業(CE0009)', true);
                //    }
                //},
                {
                    xtype: 'combo',
                    ...
                    items: [
                        {
                            ...
                            text: '三盤確認',
                            handler: function () {
                                parent.link2('/Form/Index/CE0010', ' 三盤確認(CE0010)', true);
    ...
    T1Store.on('beforeload', function (store, options) {
        ...
        T1Store.getProxy().setExtraParam('chk_level', '3');
        ...
        buttons: [

            {
                ...
                handler: function () {
                    ...
                    multiCheckWindow.setTitle("三盤數量輸入作業: " + session['UserName']);
        ...
        viewConfig: {
            listeners: {
                ...
                cellclick: function (view, cell, cellIndex, record, row, rowIndex, e) {
                    ...
                    popformINI.setTitle("三盤數量輸入作業: " + T1LastRec.data.CHK_WH_NO + " " + T1LastRec.data.CHK_YM + " " + T1LastRec.data.CHK_PERIOD + " " + T1LastRec.data.CHK_TYPE +
    ...
    var T2Tool = Ext.create('Ext.PagingToolbar', {
        ...
        buttons: [
            ...
            {
                id: 'match',
                itemId: 'match', text: '全數符合', handler: function () {
