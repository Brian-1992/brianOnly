...
Ext.onReady(function () {
            ...
            items: [
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        T11Store.setSorters({ property: sort_by.toUpperCase(), direction: sort_order.toUpperCase() });
                        T12Store.setSorters({ property: sort_by.toUpperCase(), direction: sort_order.toUpperCase() });
                        T10Store.setSorters({ property: sort_by.toUpperCase(), direction: sort_order.toUpperCase() });
    ...
    function getDefaultDateValue() {
     ...
     function updateMsgCount(checkUndoneCount) {
        Ext.Ajax.request({
            url: msgCountGet,
            method: reqVal_p,
            params:
