...
Ext.onReady(function () {
                        ...
                        items: [
                            {
                                ...
                                text: '複盤管理',
                                handler: function () {
                                    parent.link2('/Form/Index/CE0005', ' 複盤管理(CE0005)', true);
    ...
    //#region 盤點情形
    var T3Store = viewModel.getStore('DONE_STATUS');
    function T3Load() {
    ...
    popWinForm = function (param) {
        ...
        if (target != null) {
            ...
            newTab = tp.add(Ext.create('TAB.C.CE0004_1', {
                itemId: "tab" + param,
                title: param + '盤點明細',
                closable: true,
                chk_no: param
        ...
        listeners: {
            tabchange : function (me, newCard, oldCard) {
                ...
                if (newCard.itemId.indexOf('tab') == 0 && tabFlag) {
                    ...
                    var newTab = me.insert(activeTabIndex, Ext.create('TAB.C.CE0004_1', {
