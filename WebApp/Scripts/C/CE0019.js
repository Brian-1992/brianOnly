...
Ext.onReady(function () {
    ...
    var T3GetExcel = '../../../api/CE0019/Excel';
    var T3LastRec = null;
    ...
    var T1Store = Ext.create('WEBAPP.store.CE0019', {
        listeners: {
        ...
        viewConfig: {
            listeners: {
                ...
                cellclick: function (view, cell, cellIndex, record, row, rowIndex, e) {
                    ...
                    g2Window.setTitle("初盤數量輸入作業: " + T3LastRec.data.CHK_WH_NO + " " + T3LastRec.data.CHK_YM + " " + T3LastRec.data.CHK_PERIOD + " " + T3LastRec.data.CHK_TYPE +
    ...
    var viewModel = Ext.create('WEBAPP.store.CE0019VM');
