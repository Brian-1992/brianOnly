...
Ext.onReady(function () {
    ...
    var viewModel = Ext.create('WEBAPP.store.CE0005VM');
...
if (p0 != '') {
                            ...
                            items: [
                                {
                                    ...
                                    text: '前往複盤數量輸入(電腦版)',
                                    handler: function () {
                                        parent.link2('/Form/Index/CE0017', ' 複盤數量輸入作業(CE0017)', true);
        ...
        listeners: {
            ...
            cellclick: function (self, td, cellIndex, record, tr, rowIndex, e, eOpts) {
                ...
                if (Number(T1LastRec.data.CHK_STATUS) > 0 || isNaN(Number(T1LastRec.data.CHK_STATUS))) {
                    ...
                    var statusIndex1 = getColumnIndex(T21Grid.getColumns(), 'STATUS_INI_NAME');
                    //T21Grid.getColumns()[statusIndex1].hide();
                    ...
                    var statusIndex1 = getColumnIndex(T21Grid.getColumns(), 'STATUS_INI_NAME');
                    //T21Grid.getColumns()[statusIndex1].show();
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                { boxLabel: '院內碼', width: 70, name: 'ORDERWAY', inputValue: 'MMCODE' },
                                { boxLabel: '電腦量', width: 70, name: 'ORDERWAY', inputValue: 'INV_QTY' }
    ...
    var createSheetWard = function (userStore) {
        ...
        Ext.Ajax.request({
            url: '/api/CE0005/CreateSheetWard',
            method: reqVal_p,
            params: {
