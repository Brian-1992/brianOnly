...
Ext.onReady(function () {
    var tabFlag = true;
    var viewModel = Ext.create('WEBAPP.store.CE0010VM');
    ...
    popWinForm = function (param) {
        ...
        if (target != null) {
            ...
            newTab = tp.add(Ext.create('TAB.C.CE0010_INI', {
                itemId: "tab" + param,
                title: param + '盤點明細',
                closable: true,
                chk_no: param
        ...
        listeners: {
            tabchange: function (me, newCard, oldCard) {
                ...
                if (newCard.itemId.indexOf('tab') == 0 && tabFlag) {
                    ...
                    var newTab = me.insert(activeTabIndex, Ext.create('TAB.C.CE0010_INI', {
