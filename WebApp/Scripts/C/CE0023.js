...
Ext.onReady(function () {
    var T1Set = '';
    var WhnoComboGet = '../../../api/CE0023/GetWhnoCombo';
    ...
    var viewModel = Ext.create('WEBAPP.store.CE0023VM');
            ...
            },
            {
                ...
                handler: function () {
                    ...
                    Ext.MessageBox.confirm('完成盤點調整', '確定完成盤點調整?', function (btn, text) {
                        if (btn === 'yes') {
                            ModifiedSheet(sCHK_NO, sCHK_NO1);
                        }
                    }
                    );
                }
    ...
    var ModifiedSheet = function (CHK_NO, CHK_NO1) {

        var tmp_CHK_NO1 = CHK_NO1;

        Ext.Ajax.request({
            url: '/api/CE0023/ModifiedSheet',
            method: reqVal_p,
            params: {
                CHK_NO: CHK_NO,
                CHK_NO1: tmp_CHK_NO1,
