...
Ext.onReady(function () {
    //var T1Set = '';
    var T1Name = '成本單位明細報表'
    var MATComboGet = '../../../api/FA0023/GetMatCombo';
    var YMComboGet = '../../../api/FA0023/GetYMCombo';
    //var GetWh_no = '../../../api/FA0023/GetWh_no';
    var reportUrl = '/Report/F/FA0023.aspx';
    var T1GetExcel = '../../../api/FA0023/ExportExcel';
    ...
    var wh_NoCombo = Ext.create('WEBAPP.form.WH_NoCombo', {
        ...
        //指定查詢的Controller路徑
        queryUrl: '/api/FA0023/GetWH_NoCombo',
    ...
    var T1Store = Ext.create('WEBAPP.store.FA0023VM', {
        listeners: {
    ...
    var mmCodeCombo = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        //指定查詢的Controller路徑
        queryUrl: '/api/FA0023/GetMMCodeComboQ',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        //},
                        {
                            ...
                            //    change: function (checkbox, newValue, oldValue, eOpts) {
                            //        if (checkbox.checked) {
                            //            T1Query.getForm().findField('P9').setValue("Y");
                            //        } else {
                            //            T1Query.getForm().findField('P9').setValue("N");
                            //        }
                            //    }
                            //}
                        }
