...
Ext.onReady(function () {
    ...
    var viewModel = Ext.create('WEBAPP.store.FA0077VM');
    var preym = '';
    var defaultColumns = [{
        xtype: 'rownumberer',
        width: 30,
    ...
    var T1GetExcel = '../../../api/FA0077/T1Excel';
    var T2GetExcel = '../../../api/FA0077/T2Excel';
    var T3GetExcel = '../../../api/FA0077/T3Excel';
    ...
    var mmCodeCombo = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        //指定查詢的Controller路徑
        queryUrl: '/api/FA0077/GetMMCodeCombo',
