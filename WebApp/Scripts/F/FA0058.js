...
Ext.onReady(function () {
    //var T1Set = '';
    var T1Name = '成本單位明細報表'
    var MATComboGet = '../../../api/FA0058/GetMatCombo';
    var YMComboGet = '../../../api/FA0058/GetYMCombo';
    //var GetWh_no = '../../../api/AA0104/GetWh_no';
    var reportUrl = '/Report/F/FA0058.aspx';
    var T1GetExcel = '../../../api/FA0058/Excel';
    ...
    var wh_NoCombo = Ext.create('WEBAPP.form.WH_NoCombo', {
        ...
        //指定查詢的Controller路徑
        queryUrl: '/api/FA0058/GetWH_NoCombo',
    ...
    var mmCodeCombo = Ext.create('WEBAPP.form.MMCodeCombo', {
        ...
        //指定查詢的Controller路徑
        queryUrl: '/api/FA0058/GetMMCodeComboQ',
