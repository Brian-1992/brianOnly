...
var MATComboGet = '../../../api/FA0067/GetMATCombo';
var matUserID;
var today = new Date();
...
var T1GetExcel = '/api/FA0067/Excel';
var reportUrl = '/Report/F/FA0067.aspx';
...
var mmCodeCombo = Ext.create('WEBAPP.form.MMCodeCombo', {
    ...
    //指定查詢的Controller路徑
    queryUrl: '/api/FA0067/GetMMCodeCombo',
...
Ext.onReady(function () {
        ...
        items: [{
            ...
            items: [
                ...
                },
                {
                    ...
                    labelWidth: 60,
                    items: [
                        { boxLabel: '全部', name: 'rb1', width: 60, inputValue: '1', checked: true },
                        { boxLabel: '軍', name: 'rb1', width: 40, inputValue: '2' },
                        { boxLabel: '民', name: 'rb1', width: 40, inputValue: '3' },
                        { boxLabel: '醫院軍', name: 'rb1', width: 80, inputValue: '4' },
                        { boxLabel: '醫院民', name: 'rb1', width: 80, inputValue: '5' },
                        { boxLabel: '學院軍', name: 'rb1', width: 80, inputValue: '6' }
                    ]
                }
            ]
        }, {
            ...
            items: [{
                ...
                labelWidth: 60,
                items: [
                    { boxLabel: '所有品項', name: 'ISCHK', width: 70, inputValue: '0', checked: true },
                    { boxLabel: '實盤', name: 'ISCHK', width: 70, inputValue: '1' },
                    { boxLabel: '無盤點', name: 'ISCHK', width: 70, inputValue: '2', }
                ]
            }, mmCodeCombo, {
                xtype: 'button',
                text: '查詢',
                handler: function () {
                    ...
                    if (f.isValid()) {
                        ...
                        P7 = f.findField('ISCHK').getGroupValue();
    ...
    var T1Store = Ext.create('WEBAPP.store.FA0067', { // 定義於/Scripts/app/store/AA/AA0092.js
        timeout: 60000,
        listeners: {
    ...
    var T1Tool = Ext.create('Ext.PagingToolbar', {
        ...
        buttons: [
            ...
            },
            {
                ...
                fieldLabel: '',
                id: 'T1DF1',
                value: '<span style="color:blue">僅含中央庫房、藥庫、能設、通信及軍庫</span>',
                padding: '0 0 0 20'
            }
        ]
    });
    ...
    function getHospCode() {
        Ext.Ajax.request({
            url: '/api/FA0067/GetHospCode',
            method: reqVal_p,
            success: function (response) {
                var data = Ext.decode(response.responseText);
                if (data.success) {
                    if (data.msg != '0') {
                        Ext.getCmp('T1RBG1').hide();
                        Ext.getCmp('T1RBG3').hide();
                        Ext.getCmp('T1DF1').hide();
                    }
                }
            },
            failure: function (response, options) {
