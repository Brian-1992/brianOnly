...
Ext.onReady(function () {
    var T1Set = '';
    var T1Name = '中央庫房調整後庫存成本報表'
    var MATComboGet = '../../../api/FA0007/GetMatCombo';
    var GetWh_no = '../../../api/FA0007/GetWh_no';
    var reportUrl = '/Report/F/FA0007.aspx';
    var T1GetExcel = '../../../api/FA0007/Excel';
    ...
    var T1Store = Ext.create('WEBAPP.store.FA0007VM', {
        listeners: {
        ...
        buttons: [
            ...
            },
            {
                id: 't1export', text: '匯出', disabled: true, handler: function () {
                    ...
                    p.push({ name: 'FN', value: today + '_中央庫房調整後庫存成本報表.xls' });
