...
Ext.onReady(function () {
    ...
    var viewModel = Ext.create('WEBAPP.store.FA0065VM');
    var T1Store = viewModel.getStore('FA0065');
    T1Store.on({
    ...
    function showReport() {
        if (!win) {
            ...
            var winform = Ext.create('Ext.form.Panel', {
                ...
                layout: 'fit',
                closable: false,
                html: '<iframe src="/Report/F/FA0065.aspx?DATA_YM=' + np.p0 + '&MONEY1=' + np.p1 + '&MONEY2=' + np.p2 + '" id="mainContent" name="mainContent" width="100%" height="100%" frameborder="0" style="background-color:#FFFFFF"></iframe>',
                buttons: [{
                    text: '關閉',
                    handler: function () {
