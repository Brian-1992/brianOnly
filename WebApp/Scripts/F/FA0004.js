...
Ext.onReady(function () {
    ...
    var T1Name = "中央庫房差異調查表";
    var MatClassGet = '../../../api/FA0004/GetMatclassCombo';
    var T1GetExcel = '../../../api/FA0004/Excel';
    var reportUrl = '/Report/F/FA0004.aspx';
    ...
    var T1Store = Ext.create('WEBAPP.store.FA0004', { // 定義於/Scripts/app/store/F/FA0004.js 
        listeners: {
        ...
        buttons: [
            ...
            },
            {
                ...
                handler: function () {
                    ...
                    var p = new Array();
                    p.push({ name: 'FN', value: T1Query.getForm().findField('P0').rawValue + '_中央庫房差異調查表.xls' });
