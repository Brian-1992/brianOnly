...
var MATComboGet = '../../../api/FA0075/GetMATCombo';
var matUserID;
...
var mmCodeCombo = Ext.create('WEBAPP.form.MMCodeCombo', {
    ...
    limit: 10,
    //指定查詢的Controller路徑
    queryUrl: '/api/FA0075/GetMMCodeCombo',
    //查詢完會回傳的欄位
    extraFields: ['MAT_CLASS', 'BASE_UNIT']
});

var T1GetExcel = '/api/FA0075/Excel';
var reportUrl = '/Report/F/FA0075.aspx';
...
Ext.onReady(function () {
    ...
    var T1Store = Ext.create('WEBAPP.store.FA0075', { // 定義於/Scripts/app/store/AA/AA0092.js
        listeners: {
