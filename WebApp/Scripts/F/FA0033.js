...
var MATComboGet = '../../../api/FA0033/GetMATCombo';
var matUserID;
var today = new Date();
...
var T1GetExcel = '/api/FA0033/Excel';
var reportUrl = '/Report/F/FA0033.aspx';
...
var mmCodeCombo = Ext.create('WEBAPP.form.MMCodeCombo', {
    ...
    //指定查詢的Controller路徑
    queryUrl: '/api/FA0033/GetMMCodeCombo',
...
Ext.onReady(function () {
    ...
    var T1Store = Ext.create('WEBAPP.store.FA0033', { // 定義於/Scripts/app/store/AA/AA0092.js
        timeout: 60000,
        listeners: {
