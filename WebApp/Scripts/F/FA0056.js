...
Ext.onReady(function () {
    var reportUrl = '/Report/F/FA0056.aspx';
    var T1GetExcel = '/api/FA0056/Excel';
    var T3GetExcel = '/api/FA0056/Excel3';
    var T4GetExcel = '/api/FA0056/Excel4';
    // var T1Get = '/api/FA0056/All'; // 查詢(改為於store定義)
    var T1Name = "能源事務庫房庫存成本調整報表";
                ...
                },
                {
                    ...
                    handler: function () {
                        if ((T1Query.getForm().findField("P0").getValue() == null) || (T1Query.getForm().findField("P0").getValue() == "")) {
                            ...
                            var p = new Array();
                            p.push({ name: 'FN', value: '能源事務庫房庫存成本調整報表.xls' });
