...
{
    public partial class CD00103 : Page
    {
        string P0;
        string P1;
        string P2;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { new ReportParameter("UseBoxQty", P4) });

                    ReportViewer1.LocalReport.DataSources.Clear();
                    ReportViewer1.LocalReport.DisplayName = "";
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("CD00103", repo.GetPrintData3(P0, P1, P2, P3)));
