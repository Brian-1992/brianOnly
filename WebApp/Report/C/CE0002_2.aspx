<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CE0002_2.aspx.cs" Inherits="WebApp.Report.C.CE0002_2" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\C\CE0002_2.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
