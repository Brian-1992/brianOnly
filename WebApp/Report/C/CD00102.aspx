<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CD00102.aspx.cs" Inherits="WebApp.Report.C.CD00102" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\C\CD00102.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
