<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BG0009M.aspx.cs" Inherits="WebApp.Report.B.BG0009M" %>
...
<body>
    <form id="form1" runat="server">        
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\B\BG0009M.rdlc"></LocalReport>
        </rsweb:ReportViewer>
        </div>
    </form>
</body>
