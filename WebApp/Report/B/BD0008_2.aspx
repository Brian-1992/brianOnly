<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BD0008_2.aspx.cs" Inherits="WebApp.Report.B.BD0008_2" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\B\BD0008_2.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
