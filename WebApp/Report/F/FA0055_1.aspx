<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FA0055_1.aspx.cs" Inherits="WebApp.Report.F.FA0055_1" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\F\FA0055_1.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
