<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FA0038B.aspx.cs" Inherits="WebApp.Report.F.FA0038B" %>
...
<body>
    <form id="form1" runat="server">        
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\F\FA0038B.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
