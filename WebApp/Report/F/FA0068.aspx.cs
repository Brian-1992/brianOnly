...
{
    public partial class FA0068 : SiteBase.BasePage
    {
        string P0;
        string PT;
        string YYY;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    FA0068Repository repo = new FA0068Repository(DBWork);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0068", repo.GetPrintData(PT)));
