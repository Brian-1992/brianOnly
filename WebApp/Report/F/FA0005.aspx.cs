...
{
    public partial class FA0005 : Page
    {
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    FA0005Repository repo = new FA0005Repository(DBWork);
                    ReportViewer1.EnableTelemetry = false;
                    string hospCode = repo.GetHospCode();
                    IEnumerable<FA0005M> list = repo.Print(chk_ym, m_sotreid, mat_class, User.Identity.Name, hospCode=="0");
                    list = GetGroup(list);
                    list = GetCompleteData(list);
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0005", list));
        ...
        public IEnumerable<FA0005M> GetCompleteData(IEnumerable<FA0005M> list)
        {
            string lineBreak = "\n";
