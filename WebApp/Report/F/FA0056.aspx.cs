...
{
    public partial class FA0056 : SiteBase.BasePage
    {
        string P0;
        string PT;
        string YYY;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    FA0056Repository repo = new FA0056Repository(DBWork);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0056", repo.GetPrintData(PT)));
