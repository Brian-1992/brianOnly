...
{
    public partial class FA0075 : SiteBase.BasePage
    {
        string parMAT_CLASS;
        string parAPVTIME_B;
        string parAPVTIME_E;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0075", repo.Report(parMAT_CLASS, parAPVTIME_B, parAPVTIME_E, parMMCODE, isFlowid6only, isApvqtynot0)));
