...
{
    public partial class FA0067 : SiteBase.BasePage
    {
        string parMAT_CLASS;
        string parYYYMM_B;
        string parYYYMM_E;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0067", repo.Report(parMAT_CLASS, parYYYMM_B, parYYYMM_E, parP3, parP4, parMMCODE, parISCHK)));
