...
{
    public partial class FA0006 : SiteBase.BasePage
    {
        string parMAT_CLASS;
        string parDATA_YM;
        string parM_STOREID;
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                {                    
                    ...
                    if (parclsALL == true)
                    {
                        ...
                        ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0006", repo.Print(parMAT_CLASS, parDATA_YM, parM_STOREID, parMIL, parclsALL)));
                    }
                    else
                    {
                        ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0006", repo.Print(parMAT_CLASS, parDATA_YM, parM_STOREID, parMIL, parclsALL)));
