...
{
    public partial class FA0037_3 : SiteBase.BasePage
    {
            ...
            if (!IsPostBack)
            {
                ...
                using (WorkSession session = new WorkSession(this))
                {
                    ...
                    try
                    {
                        ...
                        ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0037", repo.GetReport3(P2, P0, P1, P4, P5, P6)));
