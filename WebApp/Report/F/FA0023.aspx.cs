...
{
    public partial class FA0023 : SiteBase.BasePage
    {
        string parMAT_CLASS;
        string parSET_YM;
        string parINIDFLAG;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    IEnumerable<Models.FA0023> temp = repo.Print(parMAT_CLASS, parSET_YM, parINIDFLAG, parM_STOREID, parclsALL, parWH_NO, parIS_INV_MINUS, parMMCODE, parIS_OUT_MINUS, is_pmnqty_minus, cancel_id, is_source_c, whno_cancel);
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0023", temp));
