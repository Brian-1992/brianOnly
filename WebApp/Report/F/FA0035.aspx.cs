...
{
    public partial class FA0035 : SiteBase.BasePage
    {
               ...
               p5 = (Request.QueryString["p5"] is null) ? "" : Request.QueryString["p5"].ToString().Replace("null", "");
                ...
                using (WorkSession session = new WorkSession(this))
                {
                    ...
                    try
                    {
                        ...
                        string str_ReportTittle = str_UserDept + mclsname + p5 + "~" + p2 + p4n + "總庫存量報表";
                        ...
                        ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0035", repo.GetReport( p0, p1, p2,p3,p4)));
