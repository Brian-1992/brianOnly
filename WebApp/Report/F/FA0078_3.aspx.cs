...
{
    public partial class FA0078_3 : SiteBase.BasePage
    {
        string parP0;
        string parP1;
        string parP2;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0078_3", repo.ReportInvoice(parP0, parP1, parP2, parIsTCB)));
