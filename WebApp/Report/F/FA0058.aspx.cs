...
{
    public partial class FA0058 : SiteBase.BasePage
    {
        string parMAT_CLASS;
        string parSET_YM;
        string parINIDFLAG;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    FA0058Repository repo = new FA0058Repository(DBWork);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0058", repo.GetFa0058Report(parSET_YM, parINIDFLAG, parM_STOREID, parclsALL, parWH_NO, parIS_INV_MINUS, parMMCODE, parIS_OUT_MINUS, is_pmnqty_minus, cancel_id, is_source_c, whno_cancel)));
