...
{
    public partial class FA0037 : SiteBase.BasePage
    {
            ...
            if (!IsPostBack)
            {
                ...
                using (WorkSession session = new WorkSession(this))
                {
                    ...
                    try
                    {
                        ...
                        string str_ReportTittle = "申購年月: " + P3_Y + " 年" + P3_M + " 月" + title;
                        ...
                        ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("FA0037", repo.GetReport(P2, P0, P1, P4, P5, P6)));
