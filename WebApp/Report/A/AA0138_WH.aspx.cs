...
{
    public partial class AA0138_WH : SiteBase.BasePage
    {
        string P1;
        bool isAll;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                isAll = bool.Parse(Request.QueryString["isAll"].ToString().Replace("null", ""));
                report1Bind();
            }
        }
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AA0138_WH", repo.GetWhData(P1, hospCode == "0")));
