...
{
    public partial class AA0146 : Page
    {
        string P0;
        string P1;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { new ReportParameter("P0", P0) }); //管制檔

                    ReportViewer1.LocalReport.DataSources.Clear();
                    // ReportViewer1.LocalReport.DisplayName = parDN;             
                    string hospCode = repo.GetHospCode();
                    IEnumerable<Models.AA.AA0146> temp = repo.GetReport(P0,P1, hospCode == "0");
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AA0146", temp));
