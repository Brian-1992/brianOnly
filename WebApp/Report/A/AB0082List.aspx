<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AB0082List.aspx.cs" Inherits="WebApp.Report.A.AB0082List" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\A\AB0082List.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
