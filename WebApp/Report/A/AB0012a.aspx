<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AB0012a.aspx.cs" Inherits="WebApp.Report.A.AB0012a" %>
    ...
    <form id="form1" runat="server">        
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
                <LocalReport ReportPath="Report\A\AB0012a.rdlc"></LocalReport>
            </rsweb:ReportViewer>
        </div>
    </form>
</body>
