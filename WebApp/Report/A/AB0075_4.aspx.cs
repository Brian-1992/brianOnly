...
{
    public partial class AB0075_4 : Page
    {
        string MONTH;
        string WH_NO;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    ...
                    IEnumerable<AB0075_4M> list = repo.Print_4(MONTH);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AB0075_4", list));
