...
{
    public partial class AB0059 : SiteBase.BasePage
    {
        string parMAT_CLASS;
        string parSET_YM;
        string parM_STOREID;
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    if (parclsALL == true)
                    {
                        ...
                        ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AB0059", repo.Print(parMAT_CLASS, parSET_YM, parM_STOREID, parclsALL, parWH_NO, notZeroOnly)));
                    }
                    else
                    {
                        ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AB0059", repo.Print(parMAT_CLASS, parSET_YM, parM_STOREID, parclsALL, parWH_NO, notZeroOnly)));
