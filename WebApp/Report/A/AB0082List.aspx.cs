...
{
    public partial class AB0082List : SiteBase.BasePage
    {
        ...
        protected void report1Bind()
        {
            ...
            string finalcreateShow1 = "", finalcreateShow2 = ""; //報表顯示用
            string finalfinddate1 = "", finalfinddate2 = "", usedatetime1 = "", usedatetime2 = ""; //報表顯示用
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    if (D4 != "" && D4 != null)
                    {
                        finalcreateShow1 = D4.Substring(0, 3) + "/" + D4.Substring(3, 2) + "/" + D4.Substring(5, 2) + " " + D5;
                    }
                    if (D6 != "" && D6 != null)
                    {
                        finalcreateShow2 = D6.Substring(0, 3) + "/" + D6.Substring(3, 2) + "/" + D6.Substring(5, 2) + " " + D7;
                    }
                    ...
                    ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { new ReportParameter("createShow1", finalcreateShow1) });
                    ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { new ReportParameter("createShow2", finalcreateShow2) });
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", repo.GetPrintListData(NRCODE1, NRCODE2, P0, P1, P2, P3, WH_NO, finalcreatedatetime1, finalcreatedatetime2, usedatetime1, usedatetime2)));
