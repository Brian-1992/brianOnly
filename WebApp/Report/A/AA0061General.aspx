<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AA0061General.aspx.cs" Inherits="WebApp.Report.A.AA0061General" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\A\AA0061General.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
