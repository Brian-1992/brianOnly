<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AB0075_1.aspx.cs" Inherits="WebApp.Report.A.AB0075_1" %>
...
<body>
    <form id="form1" runat="server">        
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="Report\A\AB0075_1.rdlc"></LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
</body>
