...
{
    public partial class AA0025B : System.Web.UI.Page
    {
        string P0;
        string P1;
        string YYYMM;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { new ReportParameter("P0", P0) });
                    ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { new ReportParameter("P1", P1) });
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AA0025B", repo.GetPrintDataB(P0,P1)));
