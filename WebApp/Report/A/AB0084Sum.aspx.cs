...
{
    public partial class AB0084Sum : System.Web.UI.Page
    {
        ...
        protected void report1Bind()
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AB0084Sum", repo.GetReportSum(P0, finalcreatedatetime1, finalcreatedatetime2)));
