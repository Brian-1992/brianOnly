...
{
    public partial class AB0078 : SiteBase.BasePage
    {
        string parDATA_YM;
        string parROWNUM;
        string parNONE_COST;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    AB0078Repository repo = new AB0078Repository(DBWork);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AB0078", repo.GetPrintData(parDATA_YM, parROWNUM, parNONE_COST)));
