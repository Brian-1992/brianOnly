...
{
    public partial class AA0066 : Page
    {
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    AA0066Repository repo = new AA0066Repository(DBWork);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DataSet1", repo.GetPrintData(APPTIME1, APPTIME2, MAT_CLASS, DOCTYPE, MMCODE, User.Identity.Name)));
