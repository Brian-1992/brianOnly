...
{
    public partial class AB0075_2 : Page
    {
        string MONTH;
        string WH_NO;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    ...
                    IEnumerable<AB0075_2M> list = repo.Print_2(MONTH);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AB0075_2", list));
