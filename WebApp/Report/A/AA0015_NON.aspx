<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AA0015_NON.aspx.cs" Inherits="WebApp.Report.A.AA0015_NON" %>
    ...
    <form id="form1" runat="server">        
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="100%" Width="100%" SizeToReportContent="True">
                <LocalReport ReportPath="Report\A\AA0015_NON.rdlc"></LocalReport>
            </rsweb:ReportViewer>
        </div>
    </form>
</body>
