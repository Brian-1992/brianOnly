...
{
    public partial class AB0080 : SiteBase.BasePage
    {
        string parYYYYMM;
        string parYYYYMM_D;
        string parWHG;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AB0080", repo.Report(parYYYYMM, parYYYYMM_D, parWHG, parWHGAll, parWH_NO, parMMCODE_B, parMMCODE_E)));
