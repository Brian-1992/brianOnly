...
{
    public partial class AB0075_3 : Page
    {
        string MONTH;
        string WH_NO;
        ...
        protected void report1Bind()
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    ...
                    IEnumerable<AB0075_3M> list = repo.Print_3(MONTH);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AB0075_3", list));
