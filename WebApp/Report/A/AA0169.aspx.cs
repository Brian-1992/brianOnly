...
{
    public partial class AA0169 : System.Web.UI.Page
    {
        ...
        protected void report1Bind()
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    AA0169Repository repo = new AA0169Repository(DBWork);
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("AA0169", repo.GetReport(P0, P1, P2, P4)));
