...
{
    public class AA0177 : JCLib.Mvc.BaseModel
    {
        ...
        public string NORMAL_PERC { get; set; }//正常庫存量RO倍數
        public string SUPPLY_PERC { get; set; }//供應中心最大請領RO倍數
        public string PHR_PERC { get; set; }//藥局最大請領RO倍數
        public string G34_PERC { get; set; }//護理病房最大請領RO倍數
        public string WAR_PERC { get; set; }//戰備存量RO倍數
