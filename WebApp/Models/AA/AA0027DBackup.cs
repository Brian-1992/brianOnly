...
{
    public class AA0027DBackup : JCLib.Mvc.BaseModel
    {
        ...
        public string APVQTY { get; set; } //效期數量(畫面)
        public string INV_QTY { get; set; } //效期數量(畫面)
        public string NEW_LOT_NO { get; set; } //新批號(紅底)
        public string NEW_LOT_NO_TEXT { get; set; } //新批號(紅底顯示)
        public string NEW_EXP_DATE { get; set; } //新效期(紅底)
        public string NEW_EXP_DATE_TEXT { get; set; } //新效期(紅底顯示)
        public string NEW_APVQTY { get; set; } //調整量(紅底)
        public string NEW_APVQTY_TEXT { get; set; } //調整量(紅底顯示)
