...
{
    public class FA0060 : JCLib.Mvc.BaseModel
    {
        ...
        public IEnumerable<FA0060Item> ITEMS { get; set; }
    ...
    public class FA0060Item : JCLib.Mvc.BaseModel
    {
    ...
    public class ColumnItem : JCLib.Mvc.BaseModel
    {
        public string TEXT { get; set; }
        public string DATAINDEX { get; set; }
    }

    public class FA0060DataYmItem : JCLib.Mvc.BaseModel
    {
    ...
    public class FA0060Detail : JCLib.Mvc.BaseModel {
