...
{
    public class CE0027 : JCLib.Mvc.BaseModel
    {
        IEnumerable<CE0027Data> Datas { get; set; }
        IEnumerable<CE0027Count> Count { get; set; }
    ...
    public class CE0027Data : JCLib.Mvc.BaseModel
    {
