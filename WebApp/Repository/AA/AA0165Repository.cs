...
namespace WebApp.Repository.AA
{
    ...
    public class AA0165_MODEL : JCLib.Mvc.BaseModel
    {
        ...
        public string DISC_CPRICE { get; set; } // 14.平均單價
        public string DOCTYPE { get; set; } // 15.單據類別
        public string FLOWID { get; set; } // 16.流程代碼
        public string USERID { get; set; }
    }
    public class AA0165Repository : JCLib.Mvc.BaseRepository
    {
        FL l = new FL("WebApp.Repository.AA.AA0165Repository");

        public AA0165Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }

        String sBr = "\r\n";
        //AA0165
        public IEnumerable<AA0165_MODEL> GetAll(AA0165_MODEL v, int page_index, int page_size, string sorters)
        {
            int iP = 0;
            String sP = "";
            ...
            sql += "C.BASE_UNIT, " + sBr;
            sql += "(" + sBr;
            sql += "    select avg(DISC_CPRICE) " + sBr;
            ...
            return DBWork.Connection.Query<AA0165_MODEL>(GetPagingStatement(sql, sorters), p, DBWork.Transaction);
        }
        ...
        public DataTable GetExcel(AA0165_MODEL v)
        {
            int iP = 0;
            String sP = "";
            var p = new DynamicParameters();
        ...
        public IEnumerable<AA0165_MODEL> GetPrintData(AA0165_MODEL v)
        {
            return GetAll(v, 1, 999999, "[{ property: 'DOCNO', direction: 'DESC' }]");
        } 
     
        public IEnumerable<AA0165_MODEL> GetAllByDept(string userId, string APPTIME1, string APPTIME2, string task_id, string mmcode, string showopt, string showdata, int page_index, int page_size, string sorters)
        {
            var p = new DynamicParameters();
        ...
        //AB0056
        public IEnumerable<AA0165_MODEL> GetPrintDataByDept(string userId, string APPTIME1, string APPTIME2, string task_id, string mmcode, string showopt, string showdata)
        {
            //轉成需求格式 EX:10804
            string tmpTIME1 = "", tmpTIME2 = "";
            ...
            return DBWork.Connection.Query<AA0165_MODEL>(sql, p, DBWork.Transaction);
        }
