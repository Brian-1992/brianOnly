...
{
    public class AA0091Repository : JCLib.Mvc.BaseRepository
    {
        public AA0091Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }

        public IEnumerable<AA0091M> GetAll(string p00, string p01, string p02, string p03, string p04, string p05, string p06, string p07, string p08, string p09, string p10, string p11, string p12, string p13, string p14, string p15, string p16, string p17)
        {
            ...
            return DBWork.Connection.Query<AA0091M>(sql, p, DBWork.Transaction);
        }
        ...
        public DataTable GetExcel(string p00, string p01, string p02, string p03, string p04, string p05, string p06, string p07, string p08, string p09, string p10, string p11, string p12, string p13, string p14, string p15, string p16, string p17)
        {
            ...
            string sql = @"SELECT                             
                                ...
                                A.PUBLICDRUGFLAG AS 公藥否,
                                A.STARTDATE AS 開始日期,
                                A.ORDERHOSPNAME AS 院內名稱,
                                A.ORDEREASYNAME AS 簡稱,
                                A.INSUOFFERFLAG AS 保險給付否,
                                A.DCL AS DCL,
                                ...
                                A.FIXPATHNOFLAG AS 限制途徑,
                                A.SYMPTOMCHIN AS 適應症中文,
                                A.SYMPTOMENG AS 適應症英文,
                                ...
                                A.RELATEFLAGO AS 連帶否門診,
                                A.RELATEFLAGI AS 連帶否住院,
                                A.WEIGHTTYPE AS 體重及安全量計算別,
                                A.WEIGHTUNITLIMIT AS 體重及安全量限制數量,
                                ...
                                A.CREATEDATETIME AS 記錄建立日期時間,
                                A.CREATEOPID AS 記錄建立人員,
                                A.PROCDATETIME AS 記錄處理日期時間,
                                ...
                                B.INSUSIGNI AS 健保負擔碼住院,
                                B.INSUSIGNO AS 健保負擔碼門診,
        ...
        //查詢Master
        //public IEnumerable<AA0091M> GetAllM(string MAT_CLASS, string MMCODE, string FRWH, bool clsALL ,string FLOWID, string PR_TIME_B, string PR_TIME_E, int page_index, int page_size, string sorters)
        //{
        //    var p = new DynamicParameters();
        ...
        //    return DBWork.Connection.Query<AA0091M>(GetPagingStatement(sql, sorters), p, DBWork.Transaction);
        //}

        //public IEnumerable<AA0091M> Print(string MAT_CLASS, string MMCODE, string FRWH, bool clsALL, string FLOWID, string PR_TIME_B, string PR_TIME_E)
        //{
        //    var p = new DynamicParameters();
