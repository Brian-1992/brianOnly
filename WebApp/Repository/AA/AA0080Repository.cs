...
{
    public class AA0080Repository : JCLib.Mvc.BaseRepository
    {
        public AA0080Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }
        ...
        public IEnumerable<AA0080> GetNow(string WH_NO, string YYYYMM,  int page_index, int page_size, string sorters)
        {
            ...
            var sql = @"SELECT A.DATA_YM,
                               ...
                               A.INV_QTY,
                               LAST_INVMON(A.DATA_YM,A.WH_NO,A.MMCODE)LAST_INVMONQTY
                        FROM MI_WINVMON A, 
                             MI_MAST B, 
                             MI_WHMAST C, 
                             MI_WHINV D
