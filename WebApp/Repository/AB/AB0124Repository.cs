...
{
    public class AB0124ReportMODEL : JCLib.Mvc.BaseModel
    {
    ...
    public class AB0124Repository : JCLib.Mvc.BaseRepository
    {
        public AB0124Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }

        public IEnumerable<AB0124ReportMODEL> GetPrintData(string p0)
        {
            ...
            string sql = @"SELECT B.MMCODE,C.MMNAME_E,C.BASE_UNIT,
                                  ...
                                  (SELECT DISC_CPRICE FROM MI_WHCOST 
                                    WHERE DATA_YM=:DATA_YM AND MMCODE=B.MMCODE) DISC_CPRICE
                           FROM (
            ...
            return DBWork.Connection.Query<AB0124ReportMODEL>(sql, new { data_ym = p0 }, DBWork.Transaction);
        }

        public IEnumerable<AB0124ReportMODEL> GetMiMnsetData(string p0)
        {
            var p = new DynamicParameters();
            ...
            return DBWork.Connection.Query<AB0124ReportMODEL>(sql, new { p0 = p0 }, DBWork.Transaction);
        }
