...
{
    public class AB0059Repository : JCLib.Mvc.BaseRepository
    {
        public AB0059Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }
            ...
            string sql = string.Format(@"
                     ...
                     FROM (
                      ...
                      WHERE 1=1
                        ...
                        {2}
            ", mat_class_condition //MAT_CLASS == string.Empty ? string.Empty : " and d.mat_class = :mat_class"
             , m_storeid_condition
        ...
        public IEnumerable<AB0059M> GetAll(string MAT_CLASS, string SET_YM, string M_STOREID, bool clsALL, string WH_NO, bool notZeroOnly, int page_index, int page_size, string sorters)
        {
            ...
            string sql = string.Format(@" 
                            SELECT
                                ...
                                a.in_price, a.avg_price, a.pmn_avgprice,    -- 進貨單價, 平均單價, 期初單價
            ...
            return DBWork.Connection.Query<AB0059M>(GetPagingStatement(sql, sorters), p, DBWork.Transaction);
        }

        public IEnumerable<AB0059M> Print(string MAT_CLASS, string SET_YM, string M_STOREID, bool clsALL, string WH_NO, bool notZeroOnly)
        {
            var p = new DynamicParameters();
            ...
            return DBWork.Connection.Query<AB0059M>(sql, p, DBWork.Transaction);
        }
