...
namespace WebApp.Repository.F
{
    ...
    public class FA0069ReportMODEL : JCLib.Mvc.BaseModel
    {
        ...
        public double F9 { get; set; }  //差異金額

    }
    public class FA0069Repository : JCLib.Mvc.BaseRepository
    {
        public FA0069Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }
                     ...
                     select a.wh_no, a.wh_name, 
                       ...
                       from (
                                SELECT C.WH_NO,
                                    ...
                                    sum(C.DISC_CPRICE * out_qty) as sum3,
                                    sum(C.DISC_CPRICE * inventoryqty) as sum4,
                                    sum(C.DISC_CPRICE * inv_qty) as sumtot,
                                    sum(c.p_inv_qty*(C.DISC_CPRICE-C.pmn_avgprice)) as sum5
                     FROM (
        ...
        public IEnumerable<FA0069> GetFa0069(string SET_YM, string INID_FLAG, string M_STOREID, bool clsALL, string WH_NO, string IS_INV_MINUS, string MMCODE, string IS_OUT_MINUS, string is_pmnqty_minus, string cancel_id, string is_source_c, string whno_cancel)
        {
            ...
            return DBWork.PagingQuery<FA0069>(sql, p, DBWork.Transaction);
        }
        ...
        public IEnumerable<FA0069ReportMODEL> GetFa0069Report(string SET_YM, string INID_FLAG, string M_STOREID, bool clsALL, string WH_NO, string IS_INV_MINUS, string MMCODE, string IS_OUT_MINUS, string is_pmnqty_minus, string cancel_id, string is_source_c, string whno_cancel)
        {
            var p = new DynamicParameters();
            ...
            return DBWork.Connection.Query<FA0069ReportMODEL>(sql, p, DBWork.Transaction);
        }
