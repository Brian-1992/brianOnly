...
namespace WebApp.Repository.F
{
    ...
    public class FA0059ReportMODEL : JCLib.Mvc.BaseModel
    {
    ...
    public class FA0059Repository : JCLib.Mvc.BaseRepository
    {
        public FA0059Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }


        public IEnumerable<FA0059> GetAllM(string rep_time, int page_index, int page_size, string sorters)
        {
      ...
      union select '999' as seq,'' as mat_class,9 as skey,'總計' as mat_clsname,'全部總計' as inv_type,
            ...
            return DBWork.Connection.Query<FA0059>(GetPagingStatement(sql, sorters), p, DBWork.Transaction);
        }

        public IEnumerable<FA0059ReportMODEL> GetPrintData(string rep_time)
        {
            var p = new DynamicParameters();
      ...
      union select '999' as seq,'' as mat_class,9 as skey,'總計' as mat_clsname,'全部總計' as inv_type,
            ...
            return DBWork.Connection.Query<FA0059ReportMODEL>(sql, p, DBWork.Transaction);
        }
