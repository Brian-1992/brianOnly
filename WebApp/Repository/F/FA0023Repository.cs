...
{
    public class FA0023Repository : JCLib.Mvc.BaseRepository
    {
        public FA0023Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }
        ...
        private string GetQuerySql(string MAT_CLASS, string SET_YM, string INID_FLAG, string M_STOREID, bool clsALL, string WH_NO, string IS_INV_MINUS, string MMCODE, string IS_OUT_MINUS, string is_pmnqty_minus, string cancel_id, string is_source_c, string whno_cancel) {
            ...
            string sql = string.Format(@"
                     SELECT C.WH_NO,
                            ...
                            round(avg_price * out_qty, 2) as sum3,
                            round(avg_price * inventoryqty, 2) as sum4,
                            round(avg_price * inv_qty, 2) as sumtot,
        ...
        public IEnumerable<FA0023> GetAll(string MAT_CLASS, string SET_YM, string INID_FLAG, string M_STOREID, bool clsALL, string WH_NO, string IS_INV_MINUS, string MMCODE,string IS_OUT_MINUS, string is_pmnqty_minus, string cancel_id, string is_source_c, string whno_cancel)
        {
        ...
        public IEnumerable<FA0023> Print(string MAT_CLASS, string SET_YM, string INID_FLAG, string M_STOREID, bool clsALL, string WH_NO, string IS_INV_MINUS, string MMCODE, string IS_OUT_MINUS, string is_pmnqty_minus, string cancel_id, string is_source_c, string whno_cancel)
        {
            var p = new DynamicParameters();
            ...
            return DBWork.Connection.Query<FA0023>(sql, p, DBWork.Transaction);
        }
                                ...
                                , string T3P32, string T3P33)
        {
            ...
            sql = string.Format(@" select wh_no as 單位代碼,
                                ...
                                , T3P12 == "Y" ? ",avg_price as 庫存單價" : string.Empty
