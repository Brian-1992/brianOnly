...
{
    public class FA0060Repository : JCLib.Mvc.BaseRepository
    {
        public FA0060Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }
                           ...
                           select data_ym, inid, sum(use_amount) as abs_amount,
                             ...
                             from (
                                    select b.data_ym, b.inid,
                                           (b.avg_price * b.use_qty) as USE_AMOUNT
                                      from (
        ...
        public FA0060DataYmItem GetDataYmItem()
        {
            ...
            FA0060DataYmItem item = DBWork.Connection.QueryFirstOrDefault<FA0060DataYmItem>(sql, DBWork.Transaction);
        ...
        public IEnumerable<FA0060> GetPastData(string data_ym1, string data_ym2, string grp_no, string inid, string rate)
        {
            ...
            return DBWork.PagingQuery<FA0060>(sql, p, DBWork.Transaction);
        }

        public DataTable GetT1Excel(string data_ym, string grp_no, string inid, string rate, FA0060DataYmItem ymItem)
        {
            DynamicParameters p = new DynamicParameters();
        ...
        private string GetSecondSelect1(FA0060DataYmItem ymItem)
        {
        ...
        private string GetThirdSelect1(FA0060DataYmItem ymItem)
        {
        ...
        private string GetSecondSelect2(FA0060DataYmItem ymItem)
        {
            if (IsLarger(ymItem.MaxDataym, ymItem.MinDataym) == false)
            {
                return string.Empty;
        ...
        private string GetThirdSelect2(FA0060DataYmItem ymItem)
        {
            if (IsLarger(ymItem.MaxDataym, ymItem.WK_DATE) == false)
            {
                return string.Empty;
        ...
        private string GetSecondWhere(FA0060DataYmItem ymItem)
        {
            if (IsLarger(ymItem.MaxDataym, ymItem.MinDataym) == false)
            {
                return string.Empty;
        ...
        private string GetThirdWhere(FA0060DataYmItem ymItem)
        {
            if (IsLarger(ymItem.MaxDataym, ymItem.WK_DATE) == false)
            {
                return string.Empty;
        ...
        public IEnumerable<FA0060Detail> GetDetails(string data_ym_start, string data_ym_end, string grp_no, string inid, string mmcode)
        {
            var p = new DynamicParameters();
            string sql = @"
            ...
            return DBWork.PagingQuery<FA0060Detail>(sql, p, DBWork.Transaction);
        }
        ...
        public DataTable GetT2Excel(string data_ym_start, string data_ym_end, string grp_no, string inid, string mmcode)
        {
            ...
            string sql = @"
                select DATA_YM as 年月, grp_no as 歸戶代碼,
                       ...
                       AVG_PRICE as 庫存單價 , USE_QTY as 消耗數量,USE_AMOUNT as 消耗金額,
                       TURNOVER as 週轉率,
        ...
        public FA0060DataYmItem GetT3DataYmItem(string year, string q) {
            string sql = @"
                with base_month as (                             
                ...
                select twn_yyymm(minQym) as C_MIN_QYM, 
                  ...
                  from base_month a
            ";
            return DBWork.Connection.QueryFirstOrDefault<FA0060DataYmItem>(sql, new { year, q }, DBWork.Transaction);
        }
        public IEnumerable<FA0060> GetT3PastData(string data_ym1, string data_ym2, string grp_no, string inid, bool isPaging)
        {
            ...
            if (isPaging)
            {
                ...
                return DBWork.Connection.Query<FA0060>(sql, p, DBWork.Transaction);
            }
        }
