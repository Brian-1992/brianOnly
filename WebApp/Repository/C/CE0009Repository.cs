...
namespace WebApp.Repository.C
{
    ...
    public class ﻿﻿CE0009Repository : JCLib.Mvc.BaseRepository
    {
        public ﻿﻿CE0009Repository(IUnitOfWork unitOfWork) : base(unitOfWork) { }

        public IEnumerable<﻿﻿CE0009> GetAll(string wh_no, string date, string userId, int page_index, int page_size, string sorters)
        {
...
from CHK_MAST a WHERE 1=1 ";
            ...
            return DBWork.Connection.Query<﻿﻿CE0009>(GetPagingStatement(sql, sorters), p, DBWork.Transaction);
        }

        //GET T2Grid
        public IEnumerable<﻿﻿CE0009> GetAllINI(string chk_no, string mmcodeorstore, string userId)
        {
            var p = new DynamicParameters();
            ...
            return DBWork.PagingQuery<﻿﻿CE0009>(sql, p, DBWork.Transaction);
        }

        //GET T2Grid
        public IEnumerable<﻿﻿CE0009> GetAllINIPDA(string chk_no, string mmcodeorstore, string userId, int page_index, int page_size, string sorters)
        {
            var p = new DynamicParameters();
        ...
        //GET T2Grid
        public IEnumerable<﻿﻿CE0009> GetSign(string chk_no, string userId, int page_index, int page_size, string sorters)
        {
            var p = new DynamicParameters();
        ...
        //GET T2Grid
        public IEnumerable<﻿﻿CE0009> GetNoSign(string chk_no, string userId, int page_index, int page_size, string sorters)
        {
            var p = new DynamicParameters();
        ...
        //GET T2Grid
        public IEnumerable<﻿﻿CE0009> GetAllINIotherPDA(string chk_no, string mmcodeorstore, string userId, int page_index, int page_size, string sorters)
        {
            var p = new DynamicParameters();
        ...
        //GET ifAutoLoad
        public IEnumerable<﻿﻿CE0009> GetAllINIAutoLoadPDA(string chk_no, string mmcodeorstore, string userId)
        {
            var p = new DynamicParameters();
            ...
            return DBWork.Connection.Query<﻿﻿CE0009>(sql, p, DBWork.Transaction);
        }



        //INI Query
        public IEnumerable<﻿﻿CE0009> Get﻿﻿CE0009_INI(string chk_no)
        {
            var p = new DynamicParameters();
...
from CHK_MAST a WHERE 1=1 ";
        ...
        public int Update﻿﻿CE0009_INI(﻿﻿CE0009 ce0009)
        {
            ...
            return DBWork.Connection.Execute(sql, ce0009, DBWork.Transaction);
        }

        public IEnumerable<CE0009> Get(string chk_no, string mmocde, string store_loc)
        {
            var sql = @"SELECT * FROM CHK_DETAIL WHERE chk_no = :CHK_NO and mmcode = :MMCODE and store_loc = :STORE_LOC";
            return DBWork.Connection.Query<CE0009>(sql, new { CHK_NO = chk_no, MMCODE = mmocde, STORE_LOC = store_loc }, DBWork.Transaction);
        }
        ...
        public IEnumerable<CE0009> SelectFinalPro(string chk_no, string userId)
        {
            var sql = @"Select * FROM CHK_DETAIL WHERE chk_no = :CHK_NO and chk_uid = :CHK_UID and chk_time is NULL";
            return DBWork.Connection.Query<CE0009>(sql, new { CHK_NO = chk_no, CHK_UID = userId }, DBWork.Transaction);
        }
        ...
        public int Update﻿﻿CE0009_INIPC(string CHK_QTY, string CHK_REMARK, string user, string ip, string CHK_NO, string MMCODE, string STORE_LOC)
        {
            var p = new DynamicParameters();
        ...
        public int Update﻿﻿CE0009_INI_NOTIME_PC(string CHK_QTY, string CHK_REMARK, string user, string ip, string CHK_NO, string MMCODE, string STORE_LOC)
        {
            var p = new DynamicParameters();
        ...
        public IEnumerable<﻿﻿CE0009> SelectCountSign(string chk_no) //已盤
        {
            var sql = @"Select count(*)  as sign FROM CHK_DETAIL WHERE chk_no = :CHK_NO and chk_time is not NULL";
            return DBWork.Connection.Query<﻿﻿CE0009>(sql, new { CHK_NO = chk_no }, DBWork.Transaction);
        }
        public IEnumerable<﻿﻿CE0009> SelectCountNoSign(string chk_no) //未盤
        {
