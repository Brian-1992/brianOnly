...
{
    public class BA0002Controller : SiteBase.BaseApiController
    {
        [HttpPost]
        public ApiResponse GetMST(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    var repo = new BA0002Repository(DBWork);
                    session.Result.etts = repo.GetMST(p0, p1, p2, p3, p4, DBWork.UserInfo.Inid, page, limit, sorters);
                }
                catch(Exception e)
                {
                    throw;
        ...
        public ApiResponse GetD(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    BA0002Repository repo = new BA0002Repository(DBWork);
