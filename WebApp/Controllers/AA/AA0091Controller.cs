...
{
    public class AA0091Controller : SiteBase.BaseApiController
    {
        [HttpPost]
        public ApiResponse All(FormDataCollection form)
        {
            var p00 = form.Get("p00");
            var p01 = form.Get("p01");
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    var repo = new AA0091Repository(DBWork);
        ...
        public ApiResponse Excel(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    AA0091Repository repo = new AA0091Repository(DBWork);
