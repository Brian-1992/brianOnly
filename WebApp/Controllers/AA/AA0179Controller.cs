...
{
    public class AA0179Controller : SiteBase.BaseApiController
    {
        // 查詢
        [HttpPost]
        public ApiResponse All(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    var repo = new AA0179Repository(DBWork);
        ...
        public ApiResponse GetExcel(FormDataCollection form)
        {
            var p0 = form.Get("p0");
            var p1 = form.Get("p1");
            string p2 = form.Get("p2");// 庫房代碼

            string fileName = string.Format("供應中心基準量維護_{0}.xlsx", DateTime.Now.ToString("yyyyMMddHHmmss"));
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    AA0179Repository repo = new AA0179Repository(DBWork);
        ...
        public ApiResponse Update(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                {
                    var repo = new AA0179Repository(DBWork);
                    AA0179 AA0179 = new AA0179();
                    AA0179.MMCODE = MMCODE;
                    AA0179.NOW_RO = NOW_RO;
                    AA0179.SAFE_QTY = SAFE_QTY;
                    AA0179.NORMAL_QTY = NORMAL_QTY;
                    AA0179.G34_MAX_APPQTY = G34_MAX_APPQTY;
                    AA0179.RO_TYPE = RO_TYPE;
                    AA0179.WH_NO = WH_NO;

                    session.Result.afrs = repo.Update(AA0179);
                    DBWork.Commit();
                }
                catch
                {
        ...
        public ApiResponse UpdatePerc(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    var repo = new AA0179Repository(DBWork);
                    AA0179 AA0179 = new AA0179();
                    AA0179.SAFE_PERC = SAFE_PERC;
                    AA0179.NORMAL_PERC = NORMAL_PERC;
                    AA0179.G34_PERC = G34_PERC;
                    AA0179.MMCODE = MMCODE;
                    AA0179.WH_NO = WH_NO;
                    AA0179.RO_TYPE = RO_TYPE;
                    AA0179.SAFE_QTY = SAFE_QTY;
                    ...
                    AA0179.UPDATE_USER = DBWork.UserInfo.UserId;
                    AA0179.UPDATE_IP = DBWork.ProcIP;

                    session.Result.afrs = repo.UpdatePerc(AA0179);
                    DBWork.Commit();
                }
                catch
                {
        ...
        public ApiResponse GetExcelExample(FormDataCollection form)
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    string fileName = string.Format("匯入供應中心基準量維護_{0}.xlsx", DateTime.Now.ToString("yyyyMMddHHmmss"));
                    AA0179Repository repo = new AA0179Repository(DBWork);
        ...
        public ApiResponse InsertFromXls(FormDataCollection formData)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    {
                        mi_basero_14.RO_WHTYPE = "3";
                        mi_basero_14.WH_NO = P2;
                        // 供應中心沒開放修改 平均日 自動帶入 0 
                        //mi_basero_14.DAY_USE_10 = "0";
                        //mi_basero_14.DAY_USE_14 = "0";
                        //mi_basero_14.DAY_USE_90 = "0";
