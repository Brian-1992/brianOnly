...
{
    public class AA0026Controller : SiteBase.BaseApiController
    {
        // 查詢
        [HttpPost]
                ...
                try
                {
                    ...
                    if (form.Get("DOCNO") != "")
                    {
                        ...
                        for (int i = 0; i < tmp_docno.Length; i++)
                        {
                            ...
                            repo.DeleteD_DOCEXP(tmp_docno[i], tmp_seq[i]);
                        }
                    }
                    DBWork.Commit();
                }
        ...
        public ApiResponse GetMmcode(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                {
                    AA0026Repository repo = new AA0026Repository(DBWork);
                    AA0026Repository.MI_MAST_QUERY_PARAMS query = new AA0026Repository.MI_MAST_QUERY_PARAMS();
