...
{
    public class AA0168Controller : SiteBase.BaseApiController
    {
        [HttpPost]
        ...
        public ApiResponse GetQueryData(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    var repo = new AA0168Repository(DBWork);
                    session.Result.etts = repo.GetQueryData("js", matClass, fromYM, toYM, whNo, docType, page, limit, sorters, "AA0168"); //撈出object
                }
                catch
                {
                    throw;
        ...
        public ApiResponse Excel(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    DataTable data = repo.GetExcelData("xls", matClass, fromYM, toYM, whNo, docType, printTitle, DBWork.UserInfo.UserId, frompgm);
                    ...
                    if (data.Rows.Count > 0)
                    {
                        ...
                        using (MemoryStream memoryStream = new MemoryStream())
                        {
                            ...
                            JCLib.Export.OutputFile(memoryStream, excelName);
                            workbook.Close();
                        }
                    }
                }
