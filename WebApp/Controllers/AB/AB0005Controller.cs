...
{
    public class AB0005Controller : SiteBase.BaseApiController
    {
        // 查詢
        [HttpPost]
        public ApiResponse AllM(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    var repo = new AB0005Repository(DBWork);
        ...
        public ApiResponse DeleteM(FormDataCollection form)
        {
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    AB0005Repository repo = new AB0005Repository(DBWork);
                    if (form.Get("DOCNO") != "")
                    {
        ...
        public ApiResponse GetMmcode(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                {
                    AB0005Repository repo = new AB0005Repository(DBWork);
                    AB0005Repository.MI_MAST_QUERY_PARAMS query = new AB0005Repository.MI_MAST_QUERY_PARAMS();
        ...
        public ApiResponse Excel(FormDataCollection form)
        {
            using (WorkSession session = new WorkSession())
            {
                ...
                {
                    AB0005Repository repo = new AB0005Repository(DBWork);
                    JCLib.Excel.Export("AB0005.xls", repo.GetExcel());
                }
                catch
                {
                    throw;
