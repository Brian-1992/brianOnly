...
{
    public class AB0099Controller : SiteBase.BaseApiController
    {
        // 查詢
        [HttpPost]
        public ApiResponse All(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    var repo = new AB0099Repository(DBWork);
                    AB0099Repository.ME_DOCM_QUERY_PARAMS query = new AB0099Repository.ME_DOCM_QUERY_PARAMS();
        ...
        public ApiResponse AllMeDocd(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                {
                    var repo = new AB0099Repository(DBWork);
                    AB0099Repository.ME_DOCD_QUERY_PARAMS query = new AB0099Repository.ME_DOCD_QUERY_PARAMS();
        ...
        public ApiResponse UpdateMeDocd()
        {
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    AB0099Repository repo = new AB0099Repository(DBWork);
        ...
        public ApiResponse AllMeBack(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                {
                    var repo = new AB0099Repository(DBWork);
                    session.Result.etts = repo.GetMeBack(docno, rseq);
                }
                catch
                {
                    throw;
