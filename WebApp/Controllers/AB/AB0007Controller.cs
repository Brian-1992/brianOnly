...
{
    public class AB0007Controller : SiteBase.BaseApiController
    {
        // 查詢
        [HttpPost]
        public ApiResponse AllM(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    var repo = new AB0007Repository(DBWork);
        ...
        public ApiResponse GetMmcode(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                {
                    AB0007Repository repo = new AB0007Repository(DBWork);
                    AB0007Repository.MI_MAST_QUERY_PARAMS query = new AB0007Repository.MI_MAST_QUERY_PARAMS();
