...
{
    public class FA0065Controller : SiteBase.BaseApiController
    {
        [HttpPost]
        public ApiResponse All(FormDataCollection form)
        {
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    IEnumerable<FA0065M> myEnum = repo.GetAll(form.Get("DATA_YM"));
                    ...
                    session.Result.etts = ConvertToFA0065Model(dt);
                }
                catch
                {
                    throw;
        ...
        public IEnumerable<FA0065M> ConvertToFA0065Model(DataTable dataTable)
        {
            foreach (DataRow row in dataTable.Rows)
            {
                yield return new FA0065M
                {
