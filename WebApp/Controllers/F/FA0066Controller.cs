...
{
    public class FA0066Controller : SiteBase.BaseApiController
    {
        [HttpPost]
        public ApiResponse All(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    var repo = new FA0066Repository(DBWork);
        ...
        public ApiResponse Excel(FormDataCollection form)
        {
            ...
            var T3P34 = form.Get("T3P34") == null ? string.Empty : form.Get("T3P34");  //差異金額
        ...
        public void ExportExcel(FormDataCollection form)
        {
            ...
            var T3P32 = form.Get("T3P32") == null ? string.Empty : form.Get("T3P32");
            var T3P33 = form.Get("T3P33") == null ? string.Empty : form.Get("T3P33");
            var T3P34 = form.Get("T3P34") == null ? string.Empty : form.Get("T3P34");
        ...
        public XSSFWorkbook ExoprtToExcel(DataTable data, string tt1, string tt2, string tt3)
        {
            ...
            row.CreateCell(0).SetCellValue("衛星庫房(" + tt1 + ")" + tt2 + "類庫存成本單位明細報表 (FA0066) (" + tt3 + ")");
