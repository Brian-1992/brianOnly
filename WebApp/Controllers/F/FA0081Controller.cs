...
{
    public class FA0081Controller : SiteBase.BaseApiController
    {
        ...
        public ApiResponse AllM(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    var repo = new FA0081Repository(DBWork);
                    session.Result.etts = repo.GetAllM(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, user, page, limit, sorters);
                }
                catch
                {
                    throw;
        ...
        //        {
        //            var repo = new FA0081Repository(DBWork);
        //            session.Result.etts = repo.GetAllD(p0, p1, p2, p3, p4, p5, p6, p7, p8, YYYMM, isab, user, page, limit, sorters);
        //        }
        //        catch
        //        {
        //            throw;
        ...
        public ApiResponse GetCancelIdCombo()
        {
            using (WorkSession session = new WorkSession())
            {
                var DBWork = session.UnitOfWork;
                ...
                {
                    var repo = new FA0081Repository(DBWork);
                    session.Result.etts = repo.GetCancelIdCombo();
                }
                catch
                {
                    throw;
        ...
        public ApiResponse Excel(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    JCLib.Excel.Export("低周轉率報表" + "_" + DateTime.Now.ToString("yyyyMMddhhmm") + ".xls", repo.GetExcel(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, user));
                }
                catch
                {
                    throw;
