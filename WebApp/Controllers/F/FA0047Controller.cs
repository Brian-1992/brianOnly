...
{
    public class FA0047Controller : SiteBase.BaseApiController
    {
        // 查詢
        [HttpPost]
        public ApiResponse All(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    var repo = new FA0047Repository(DBWork);
                    session.Result.etts = repo.GetAll(MAT_CLASS, YYYMM_B, YYYMM_E, P3, P4, MMCODE, page, limit, sorters);
        ...
        public ApiResponse Excel(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    JCLib.Excel.Export("進銷存報表" + "_" + DateTime.Now.ToString("yyyyMMddhhmm") + ".xls", repo.GetExcel(MAT_CLASS, YYYMM_B, YYYMM_E, P3, P4, MMCODE),
                         (dt) =>
                         {
