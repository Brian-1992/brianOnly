...
{
    public class FA0058Controller : SiteBase.BaseApiController
    {
        public ApiResponse All(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession(this))
            {
                ...
                try
                {
                    ...
                    var repo = new FA0058Repository(DBWork);
                    session.Result.etts = repo.GetFa0058(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12);
                }
                catch
                {
                    throw;
