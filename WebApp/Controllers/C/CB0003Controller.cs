...
{
    public class CB0003Controller: SiteBase.BaseApiController
    {
        [HttpPost]
        public ApiResponse All(FormDataCollection form) {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    var repo = new CB0003Repository(DBWork);
        ...
        public ApiResponse Excel(FormDataCollection form)
        {
            ...
            using (WorkSession session = new WorkSession())
            {
                ...
                try
                {
                    CB0003Repository repo = new CB0003Repository(DBWork);
                    ...
                    DataTable result = repo.GetExcel(p0, p1, p2, p3,p4);
