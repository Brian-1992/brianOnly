...
namespace Tsghmm.Utility
{
    class SendMail
    {
        ...
        public bool Send_Mail(string fromMail, string toMail, string toMailCC, string mail_type, string toSubject, string toContent, string create_user, string toContentLog)
        {
            bool rtn = true;
