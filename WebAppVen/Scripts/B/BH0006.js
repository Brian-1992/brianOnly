...
Ext.onReady(function () {
    ...
    //取得網址 http://localhost:54835/Form/Show/B/BH0006?AC-24-D1-AE-FC-C7-A4-1E-D3-AD-61-47-79-4E-52-6D-C1-56-04-57-25-F4-AD-17-F3-95-A8-8C-8D-D7-BE-8A-77-4A-B2-7A-44-4A-C6-00
    UrlString_original = location.href;

    //分割字串把分割後的字串放進陣列中
    UrlString_before = UrlString_original.split('?');
    //此時UrlString_before裡的內容為：
    //UrlString_before[0] = 'localhost:54835/Form/Index/BH0006'
