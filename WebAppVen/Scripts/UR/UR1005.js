...
Ext.onReady(function () {
    ...
    var T1Update = '/api/UR1005/Update'; //修編
    var T1Delete = '/api/UR1005/Delete'; //刪除
    var T1Set = T1Update;
    var T1UpdateFS = '/api/UR1005/UpdateFS'; //修編
    ...
    var T1Store = getTreeStore('YS');
    var T2Store = getTreeStore('MOBILE');
        ...
        return Ext.create('Ext.tree.Panel', {
            ...
            columns: [{
                ...
                renderer: function (val, meta, record) {
                    ...
                    if (_fu && _fu.length > 0) _fu = '/Scripts/<span style="color:red;">' + _fu + '</span>.js';
